  ...
  module R5
    class StructureMap < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'StructureMap.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'versionAlgorithmString' => {'path'=>'StructureMap.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'StructureMap.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        ...
        'copyrightLabel' => {'path'=>'StructureMap.copyrightLabel', 'type'=>'string', 'min'=>0, 'max'=>1},
        ...
        'const' => {'path'=>'StructureMap.const', 'type'=>'StructureMap::Const', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Const < Model
        ...
        METADATA = {
          'id' => {'path'=>'Const.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Const.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Const.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'name' => {'path'=>'Const.name', 'type'=>'id', 'min'=>0, 'max'=>1},
          'value' => {'path'=>'Const.value', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class Group < Model
        ...
        METADATA = {
          ...
          'typeMode' => {'valid_codes'=>{'http://hl7.org/fhir/map-group-type-mode'=>['types', 'type-and-types']}, 'path'=>'Group.typeMode', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/map-group-type-mode'}},
          ...
          'rule' => {'path'=>'Group.rule', 'type'=>'StructureMap::Group::Rule', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class Rule < Model
          ...
          METADATA = {
            ...
            'name' => {'path'=>'Rule.name', 'type'=>'id', 'min'=>0, 'max'=>1},
          ...
          class Source < Model
            ...
            METADATA = {
              ...
              'defaultValue' => {'path'=>'Source.defaultValue', 'type'=>'string', 'min'=>0, 'max'=>1},
          ...
          class Target < Model
            ...
            METADATA = {
              ...
              'context' => {'path'=>'Target.context', 'type'=>'string', 'min'=>0, 'max'=>1},
              'element' => {'path'=>'Target.element', 'type'=>'string', 'min'=>0, 'max'=>1},
              'variable' => {'path'=>'Target.variable', 'type'=>'id', 'min'=>0, 'max'=>1},
              'listMode' => {'valid_codes'=>{'http://hl7.org/fhir/map-target-list-mode'=>['first', 'share', 'last', 'single']}, 'path'=>'Target.listMode', 'type'=>'code', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/map-target-list-mode'}},
            ...
            class Parameter < Model
              ...
              METADATA = {
                ...
                'valueDate' => {'path'=>'Parameter.value[x]', 'type'=>'date', 'min'=>1, 'max'=>1},
                'valueTime' => {'path'=>'Parameter.value[x]', 'type'=>'time', 'min'=>1, 'max'=>1},
                'valueDateTime' => {'path'=>'Parameter.value[x]', 'type'=>'dateTime', 'min'=>1, 'max'=>1}
              }
          ...
          class Dependent < Model
            ...
            METADATA = {
              ...
              'parameter' => {'path'=>'Dependent.parameter', 'type'=>'StructureMap::Group::Rule::Target::Parameter', 'min'=>1, 'max'=>Float::INFINITY}
            }

  ...
  module R5
    class SubscriptionTopic < Model
      ...
      class ResourceTrigger < Model
        ...
        METADATA = {
          'id' => {'path'=>'ResourceTrigger.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'ResourceTrigger.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'ResourceTrigger.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'ResourceTrigger.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'resource' => {'path'=>'ResourceTrigger.resource', 'type'=>'uri', 'min'=>1, 'max'=>1},
          'supportedInteraction' => {'valid_codes'=>{'http://hl7.org/fhir/restful-interaction'=>['create', 'update', 'delete']}, 'path'=>'ResourceTrigger.supportedInteraction', 'type'=>'code', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/interaction-trigger'}},
          'queryCriteria' => {'path'=>'ResourceTrigger.queryCriteria', 'type'=>'SubscriptionTopic::ResourceTrigger::QueryCriteria', 'min'=>0, 'max'=>1},
          'fhirPathCriteria' => {'path'=>'ResourceTrigger.fhirPathCriteria', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
        ...
        class QueryCriteria < Model
          ...
          METADATA = {
            'id' => {'path'=>'QueryCriteria.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'QueryCriteria.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'QueryCriteria.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'previous' => {'path'=>'QueryCriteria.previous', 'type'=>'string', 'min'=>0, 'max'=>1},
            'resultForCreate' => {'valid_codes'=>{'http://hl7.org/fhir/subscriptiontopic-cr-behavior'=>['test-passes', 'test-fails']}, 'path'=>'QueryCriteria.resultForCreate', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/subscriptiontopic-cr-behavior'}},
            'current' => {'path'=>'QueryCriteria.current', 'type'=>'string', 'min'=>0, 'max'=>1},
            'resultForDelete' => {'valid_codes'=>{'http://hl7.org/fhir/subscriptiontopic-cr-behavior'=>['test-passes', 'test-fails']}, 'path'=>'QueryCriteria.resultForDelete', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/subscriptiontopic-cr-behavior'}},
            'requireBoth' => {'path'=>'QueryCriteria.requireBoth', 'type'=>'boolean', 'min'=>0, 'max'=>1}
          }
      ...
      class CanFilterBy < Model
        ...
        METADATA = {
          'id' => {'path'=>'CanFilterBy.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'CanFilterBy.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'CanFilterBy.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'CanFilterBy.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'resource' => {'path'=>'CanFilterBy.resource', 'type'=>'uri', 'min'=>0, 'max'=>1},
          'filterParameter' => {'path'=>'CanFilterBy.filterParameter', 'type'=>'string', 'min'=>1, 'max'=>1},
          'filterDefinition' => {'path'=>'CanFilterBy.filterDefinition', 'type'=>'uri', 'min'=>0, 'max'=>1},
          'comparator' => {'valid_codes'=>{'http://hl7.org/fhir/search-comparator'=>['eq', 'ne', 'gt', 'lt', 'ge', 'le', 'sa', 'eb', 'ap']}, 'path'=>'CanFilterBy.comparator', 'type'=>'code', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/search-comparator'}},
          'modifier' => {'valid_codes'=>{'http://hl7.org/fhir/search-modifier-code'=>['missing', 'exact', 'contains', 'not', 'text', 'in', 'not-in', 'below', 'above', 'type', 'identifier', 'of-type', 'code-text', 'text-advanced', 'iterate']}, 'path'=>'CanFilterBy.modifier', 'type'=>'code', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/search-modifier-code'}}
        }
      ...
      class NotificationShape < Model
        ...
        METADATA = {
          'id' => {'path'=>'NotificationShape.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'NotificationShape.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'NotificationShape.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'resource' => {'path'=>'NotificationShape.resource', 'type'=>'uri', 'min'=>1, 'max'=>1},
          'include' => {'path'=>'NotificationShape.include', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY},
          'revInclude' => {'path'=>'NotificationShape.revInclude', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY}
        }

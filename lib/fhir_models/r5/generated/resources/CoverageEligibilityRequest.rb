  ...
  module R5
    class CoverageEligibilityRequest < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'CoverageEligibilityRequest.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'event' => {'path'=>'CoverageEligibilityRequest.event', 'type'=>'CoverageEligibilityRequest::Event', 'min'=>0, 'max'=>Float::INFINITY},

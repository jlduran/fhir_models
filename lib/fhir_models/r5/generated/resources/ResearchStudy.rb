  ...
  module R5
    class ResearchStudy < Model
      ...
      class Label < Model
        ...
        METADATA = {
          'id' => {'path'=>'Label.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Label.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Label.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/title-type'=>['primary', 'official', 'scientific', 'plain-language', 'subtitle', 'short-title', 'acronym', 'earlier-title', 'language', 'autotranslated', 'human-use', 'machine-use', 'duplicate-uid']}, 'path'=>'Label.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/title-type'}},
          'value' => {'path'=>'Label.value', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class AssociatedParty < Model
        ...
        METADATA = {
          'id' => {'path'=>'AssociatedParty.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'AssociatedParty.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'AssociatedParty.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'name' => {'path'=>'AssociatedParty.name', 'type'=>'string', 'min'=>0, 'max'=>1},
          'role' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-party-role'=>['sponsor', 'lead-sponsor', 'sponsor-investigator', 'primary-investigator', 'collaborator', 'funding-source', 'general-contact', 'recruitment-contact', 'sub-investigator', 'study-director', 'study-chair', 'irb']}, 'path'=>'AssociatedParty.role', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-party-role'}},
          'period' => {'path'=>'AssociatedParty.period', 'type'=>'Period', 'min'=>0, 'max'=>Float::INFINITY},
          'classifier' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-party-organization-type'=>['nih', 'fda', 'government', 'nonprofit', 'academic', 'industry']}, 'path'=>'AssociatedParty.classifier', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-party-organization-type'}},
          'party' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'AssociatedParty.party', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class ProgressStatus < Model
        ...
        METADATA = {
          'id' => {'path'=>'ProgressStatus.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'ProgressStatus.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'ProgressStatus.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'state' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-status'=>['overall-study', 'active', 'active-but-not-recruiting', 'administratively-completed', 'approved', 'closed-to-accrual', 'closed-to-accrual-and-intervention', 'completed', 'disapproved', 'enrolling-by-invitation', 'in-review', 'not-yet-recruiting', 'recruiting', 'temporarily-closed-to-accrual', 'temporarily-closed-to-accrual-and-intervention', 'terminated', 'withdrawn']}, 'path'=>'ProgressStatus.state', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-status'}},
          'actual' => {'path'=>'ProgressStatus.actual', 'type'=>'boolean', 'min'=>0, 'max'=>1},
          'period' => {'path'=>'ProgressStatus.period', 'type'=>'Period', 'min'=>0, 'max'=>1}
        }
      ...
      class Recruitment < Model
        ...
        METADATA = {
          'id' => {'path'=>'Recruitment.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Recruitment.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Recruitment.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'targetNumber' => {'path'=>'Recruitment.targetNumber', 'type'=>'unsignedInt', 'min'=>0, 'max'=>1},
          'actualNumber' => {'path'=>'Recruitment.actualNumber', 'type'=>'unsignedInt', 'min'=>0, 'max'=>1},
          'eligibility' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group', 'http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'Recruitment.eligibility', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          'actualGroup' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'Recruitment.actualGroup', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class ComparisonGroup < Model
        ...
        METADATA = {
          'id' => {'path'=>'ComparisonGroup.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'ComparisonGroup.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'ComparisonGroup.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'linkId' => {'path'=>'ComparisonGroup.linkId', 'type'=>'id', 'min'=>0, 'max'=>1},
          'name' => {'path'=>'ComparisonGroup.name', 'type'=>'string', 'min'=>1, 'max'=>1},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-arm-type'=>['active-comparator', 'placebo-comparator', 'sham-comparator', 'no-intervention', 'experimental', 'other-arm-type']}, 'path'=>'ComparisonGroup.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-arm-type'}},
          'description' => {'path'=>'ComparisonGroup.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'intendedExposure' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'ComparisonGroup.intendedExposure', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
          'observedGroup' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'ComparisonGroup.observedGroup', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class Objective < Model
        ...
        METADATA = {
          'id' => {'path'=>'Objective.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Objective.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Objective.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'name' => {'path'=>'Objective.name', 'type'=>'string', 'min'=>0, 'max'=>1},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-objective-type'=>['primary', 'secondary', 'exploratory']}, 'path'=>'Objective.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-objective-type'}},
          'description' => {'path'=>'Objective.description', 'type'=>'markdown', 'min'=>0, 'max'=>1}
        }
      ...
      class OutcomeMeasure < Model
        ...
        METADATA = {
          'id' => {'path'=>'OutcomeMeasure.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'OutcomeMeasure.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'OutcomeMeasure.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'name' => {'path'=>'OutcomeMeasure.name', 'type'=>'string', 'min'=>0, 'max'=>1},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/research-study-objective-type'=>['primary', 'secondary', 'exploratory']}, 'path'=>'OutcomeMeasure.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-objective-type'}},
          'description' => {'path'=>'OutcomeMeasure.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'reference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'OutcomeMeasure.reference', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }

  ...
  module R5
    class Measure < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'Measure.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'versionAlgorithmString' => {'path'=>'Measure.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'Measure.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        ...
        'scoring' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-scoring'=>['proportion', 'ratio', 'continuous-variable', 'cohort', 'composite']}, 'path'=>'Measure.scoring', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://terminology.hl7.org/ValueSet/measure-scoring'}},
        'scoringUnit' => {'valid_codes'=>{'http://unitsofmeasure.org'=>['1', '/1000.d']}, 'path'=>'Measure.scoringUnit', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-scoring-unit'}},
        ...
        'riskAdjustment' => {'path'=>'Measure.riskAdjustment', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'rateAggregation' => {'path'=>'Measure.rateAggregation', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        ...
        'term' => {'path'=>'Measure.term', 'type'=>'Measure::Term', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Term < Model
        ...
        METADATA = {
          ...
          'code' => {'valid_codes'=>{'http://hl7.org/fhir/measure-definition-example'=>['screening', 'standardized-depression-screening-tool']}, 'path'=>'Term.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-definition-example'}},
          'definition' => {'path'=>'Term.definition', 'type'=>'markdown', 'min'=>0, 'max'=>1}
        }
      ...
      class Group < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-type'=>['process', 'outcome', 'structure', 'patient-reported-outcome', 'composite']}, 'path'=>'Group.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-type'}},
          'subjectCodeableConcept' => {'valid_codes'=>{'http://hl7.org/fhir/fhir-types'=>['CareTeam', 'Device', 'Group', 'HealthcareService', 'Location', 'Organization', 'Patient', 'Practitioner', 'PractitionerRole', 'RelatedPerson']}, 'path'=>'Group.subject[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/participant-resource-types'}},
          'subjectReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'Group.subject[x]', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          'basis' => {'valid_codes'=>{'http://hl7.org/fhir/fhir-types'=>['Base', 'Element', 'BackboneElement', 'DataType', 'Address', 'Annotation', 'Attachment', 'Availability', 'BackboneType', 'Dosage', 'ElementDefinition', 'MarketingStatus', 'ProductShelfLife', 'Timing', 'CodeableConcept', 'CodeableReference', 'Coding', 'ContactDetail', 'ContactPoint', 'Contributor', 'DataRequirement', 'Expression', 'ExtendedContactDetail', 'Extension', 'HumanName', 'Identifier', 'Meta', 'MonetaryComponent', 'Money', 'Narrative', 'ParameterDefinition', 'Period', 'PrimitiveType', 'base64Binary', 'boolean', 'date', 'dateTime', 'decimal', 'instant', 'integer', 'positiveInt', 'unsignedInt', 'integer64', 'string', 'code', 'id', 'markdown', 'time', 'uri', 'canonical', 'oid', 'url', 'uuid', 'Quantity', 'Age', 'Count', 'Distance', 'Duration', 'Range', 'Ratio', 'RatioRange', 'Reference', 'RelatedArtifact', 'SampledData', 'Signature', 'TriggerDefinition', 'UsageContext', 'VirtualServiceDetail', 'xhtml', 'Resource', 'Binary', 'Bundle', 'DomainResource', 'Account', 'ActivityDefinition', 'ActorDefinition', 'AdministrableProductDefinition', 'AdverseEvent', 'AllergyIntolerance', 'Appointment', 'AppointmentResponse', 'ArtifactAssessment', 'AuditEvent', 'Basic', 'BiologicallyDerivedProduct', 'BiologicallyDerivedProductDispense', 'BodyStructure', 'CanonicalResource', 'CapabilityStatement', 'CarePlan', 'CareTeam', 'ChargeItem', 'ChargeItemDefinition', 'Citation', 'Claim', 'ClaimResponse', 'ClinicalImpression', 'ClinicalUseDefinition', 'CodeSystem', 'Communication', 'CommunicationRequest', 'CompartmentDefinition', 'Composition', 'ConceptMap', 'Condition', 'ConditionDefinition', 'Consent', 'Contract', 'Coverage', 'CoverageEligibilityRequest', 'CoverageEligibilityResponse', 'DetectedIssue', 'Device', 'DeviceAssociation', 'DeviceDefinition', 'DeviceDispense', 'DeviceMetric', 'DeviceRequest', 'DeviceUsage', 'DiagnosticReport', 'DocumentReference', 'Encounter', 'EncounterHistory', 'Endpoint', 'EnrollmentRequest', 'EnrollmentResponse', 'EpisodeOfCare', 'EventDefinition', 'Evidence', 'EvidenceReport', 'EvidenceVariable', 'ExampleScenario', 'ExplanationOfBenefit', 'FamilyMemberHistory', 'Flag', 'FormularyItem', 'GenomicStudy', 'Goal', 'GraphDefinition', 'Group', 'GuidanceResponse', 'HealthcareService', 'ImagingSelection', 'ImagingStudy', 'Immunization', 'ImmunizationEvaluation', 'ImmunizationRecommendation', 'ImplementationGuide', 'Ingredient', 'InsurancePlan', 'InventoryItem', 'InventoryReport', 'Invoice', 'Library', 'Linkage', 'List', 'Location', 'ManufacturedItemDefinition', 'Measure', 'MeasureReport', 'Medication', 'MedicationAdministration', 'MedicationDispense', 'MedicationKnowledge', 'MedicationRequest', 'MedicationStatement', 'MedicinalProductDefinition', 'MessageDefinition', 'MessageHeader', 'MetadataResource', 'MolecularSequence', 'NamingSystem', 'NutritionIntake', 'NutritionOrder', 'NutritionProduct', 'Observation', 'ObservationDefinition', 'OperationDefinition', 'OperationOutcome', 'Organization', 'OrganizationAffiliation', 'PackagedProductDefinition', 'Patient', 'PaymentNotice', 'PaymentReconciliation', 'Permission', 'Person', 'PlanDefinition', 'Practitioner', 'PractitionerRole', 'Procedure', 'Provenance', 'Questionnaire', 'QuestionnaireResponse', 'RegulatedAuthorization', 'RelatedPerson', 'RequestOrchestration', 'Requirements', 'ResearchStudy', 'ResearchSubject', 'RiskAssessment', 'Schedule', 'SearchParameter', 'ServiceRequest', 'Slot', 'Specimen', 'SpecimenDefinition', 'StructureDefinition', 'StructureMap', 'Subscription', 'SubscriptionStatus', 'SubscriptionTopic', 'Substance', 'SubstanceDefinition', 'SubstanceNucleicAcid', 'SubstancePolymer', 'SubstanceProtein', 'SubstanceReferenceInformation', 'SubstanceSourceMaterial', 'SupplyDelivery', 'SupplyRequest', 'Task', 'TerminologyCapabilities', 'TestPlan', 'TestReport', 'TestScript', 'Transport', 'ValueSet', 'VerificationResult', 'VisionPrescription', 'Parameters']}, 'path'=>'Group.basis', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/fhir-types'}},
          'scoring' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-scoring'=>['proportion', 'ratio', 'continuous-variable', 'cohort', 'composite']}, 'path'=>'Group.scoring', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://terminology.hl7.org/ValueSet/measure-scoring'}},
          'scoringUnit' => {'valid_codes'=>{'http://unitsofmeasure.org'=>['1', '/1000.d']}, 'path'=>'Group.scoringUnit', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-scoring-unit'}},
          'rateAggregation' => {'path'=>'Group.rateAggregation', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'improvementNotation' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-improvement-notation'=>['increase', 'decrease']}, 'path'=>'Group.improvementNotation', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-improvement-notation'}},
          'library' => {'path'=>'Group.library', 'type'=>'canonical', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Population < Model
          ...
          METADATA = {
            ...
            'description' => {'path'=>'Population.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
            'criteria' => {'path'=>'Population.criteria', 'type'=>'Expression', 'min'=>0, 'max'=>1},
            'groupDefinition' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'Population.groupDefinition', 'type'=>'Reference', 'min'=>0, 'max'=>1},
            'inputPopulationId' => {'path'=>'Population.inputPopulationId', 'type'=>'string', 'min'=>0, 'max'=>1},
            'aggregateMethod' => {'valid_codes'=>{'http://hl7.org/fhir/CodeSystem/measure-aggregate-method'=>['sum', 'average', 'median', 'minimum', 'maximum', 'count']}, 'path'=>'Population.aggregateMethod', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-aggregate-method'}}
          }
        ...
        class Stratifier < Model
          ...
          METADATA = {
            ...
            'description' => {'path'=>'Stratifier.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
            'criteria' => {'path'=>'Stratifier.criteria', 'type'=>'Expression', 'min'=>0, 'max'=>1},
            'groupDefinition' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'Stratifier.groupDefinition', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          ...
          class Component < Model
            ...
            METADATA = {
              ...
              'code' => {'valid_codes'=>{'http://hl7.org/fhir/measure-stratifier-example'=>['age', 'gender', 'region']}, 'path'=>'Component.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-stratifier-example'}},
              'description' => {'path'=>'Component.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
              'criteria' => {'path'=>'Component.criteria', 'type'=>'Expression', 'min'=>0, 'max'=>1},
              'groupDefinition' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'Component.groupDefinition', 'type'=>'Reference', 'min'=>0, 'max'=>1}
            }
      ...
      class SupplementalData < Model
        ...
        METADATA = {
          ...
          'linkId' => {'path'=>'SupplementalData.linkId', 'type'=>'string', 'min'=>0, 'max'=>1},
          'code' => {'valid_codes'=>{'http://hl7.org/fhir/measure-supplemental-data-example'=>['age', 'gender', 'ethnicity', 'payer']}, 'path'=>'SupplementalData.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-supplemental-data-example'}},
          ...
          'description' => {'path'=>'SupplementalData.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},

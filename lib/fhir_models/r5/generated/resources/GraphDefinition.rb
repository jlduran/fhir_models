  ...
  module R5
    class GraphDefinition < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'GraphDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'identifier' => {'path'=>'GraphDefinition.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'path'=>'GraphDefinition.version', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmString' => {'path'=>'GraphDefinition.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'GraphDefinition.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        'name' => {'path'=>'GraphDefinition.name', 'type'=>'string', 'min'=>1, 'max'=>1},
        'title' => {'path'=>'GraphDefinition.title', 'type'=>'string', 'min'=>0, 'max'=>1},
      ...
      class Link < Model
        ...
        METADATA = {
          ...
          'sourceId' => {'path'=>'Link.sourceId', 'type'=>'id', 'min'=>1, 'max'=>1},
          'path' => {'path'=>'Link.path', 'type'=>'string', 'min'=>0, 'max'=>1},
          'sliceName' => {'path'=>'Link.sliceName', 'type'=>'string', 'min'=>0, 'max'=>1},
          'targetId' => {'path'=>'Link.targetId', 'type'=>'id', 'min'=>1, 'max'=>1},
          'params' => {'path'=>'Link.params', 'type'=>'string', 'min'=>0, 'max'=>1},
          'compartment' => {'path'=>'Link.compartment', 'type'=>'GraphDefinition::Link::Compartment', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class Compartment < Model
          ...
          METADATA = {
            ...
            'use' => {'valid_codes'=>{'http://hl7.org/fhir/graph-compartment-use'=>['where', 'requires']}, 'path'=>'Compartment.use', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/graph-compartment-use'}},
            ...
            'code' => {'valid_codes'=>{'http://hl7.org/fhir/compartment-type'=>['Patient', 'Encounter', 'RelatedPerson', 'Practitioner', 'Device', 'EpisodeOfCare']}, 'path'=>'Compartment.code', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/compartment-type'}},

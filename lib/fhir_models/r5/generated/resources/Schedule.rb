module FHIR
  module R5
    class Schedule < Model
      ...
      METADATA = {
        'id' => {'path'=>'Schedule.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'Schedule.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'Schedule.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'path'=>'Schedule.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        'text' => {'path'=>'Schedule.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'Schedule.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},

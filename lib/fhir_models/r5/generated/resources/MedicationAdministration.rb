module FHIR
  module R5
    class MedicationAdministration < Model
      ...
      METADATA = {
        'id' => {'path'=>'MedicationAdministration.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'MedicationAdministration.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'MedicationAdministration.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'path'=>'MedicationAdministration.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        'text' => {'path'=>'MedicationAdministration.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'MedicationAdministration.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'MedicationAdministration.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'MedicationAdministration.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'identifier' => {'path'=>'MedicationAdministration.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'basedOn' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/CarePlan'], 'path'=>'MedicationAdministration.basedOn', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'partOf' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicationAdministration', 'http://hl7.org/fhir/StructureDefinition/Procedure', 'http://hl7.org/fhir/StructureDefinition/MedicationDispense'], 'path'=>'MedicationAdministration.partOf', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/CodeSystem/medication-admin-status'=>['in-progress', 'not-done', 'on-hold', 'completed', 'entered-in-error', 'stopped', 'unknown']}, 'path'=>'MedicationAdministration.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-admin-status'}},
        'statusReason' => {'valid_codes'=>{'http://snomed.info/sct'=>['242990004', '182895007', '182896008', '182897004', '182898009', '182899001', '182900006', '182901005', '182902003', '182903008']}, 'path'=>'MedicationAdministration.statusReason', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/reason-medication-not-given-codes'}},
        'category' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/medication-admin-location'=>['inpatient', 'outpatient', 'community']}, 'path'=>'MedicationAdministration.category', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-admin-location'}},
        'medication' => {'path'=>'MedicationAdministration.medication', 'type'=>'CodeableReference', 'min'=>1, 'max'=>1},
        'subject' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'MedicationAdministration.subject', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'encounter' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Encounter'], 'path'=>'MedicationAdministration.encounter', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'supportingInformation' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'path'=>'MedicationAdministration.supportingInformation', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'occurenceDateTime' => {'path'=>'MedicationAdministration.occurence[x]', 'type'=>'dateTime', 'min'=>1, 'max'=>1},
        'occurencePeriod' => {'path'=>'MedicationAdministration.occurence[x]', 'type'=>'Period', 'min'=>1, 'max'=>1},
        'occurenceTiming' => {'path'=>'MedicationAdministration.occurence[x]', 'type'=>'Timing', 'min'=>1, 'max'=>1},
        'recorded' => {'path'=>'MedicationAdministration.recorded', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'isSubPotent' => {'path'=>'MedicationAdministration.isSubPotent', 'type'=>'boolean', 'min'=>0, 'max'=>1},
        'subPotentReason' => {'valid_codes'=>{'http://hl7.org/fhir/CodeSystem/administration-subpotent-reason'=>['partialdose', 'vomited', 'coldchainbreak', 'recall', 'adversestorage', 'expired']}, 'path'=>'MedicationAdministration.subPotentReason', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/administration-subpotent-reason'}},
        'performer' => {'path'=>'MedicationAdministration.performer', 'type'=>'MedicationAdministration::Performer', 'min'=>0, 'max'=>Float::INFINITY},
        'reason' => {'path'=>'MedicationAdministration.reason', 'type'=>'CodeableReference', 'min'=>0, 'max'=>Float::INFINITY},
        'request' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicationRequest'], 'path'=>'MedicationAdministration.request', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'device' => {'path'=>'MedicationAdministration.device', 'type'=>'CodeableReference', 'min'=>0, 'max'=>Float::INFINITY},
        'note' => {'path'=>'MedicationAdministration.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
        'dosage' => {'path'=>'MedicationAdministration.dosage', 'type'=>'MedicationAdministration::Dosage', 'min'=>0, 'max'=>1},
        'eventHistory' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Provenance'], 'path'=>'MedicationAdministration.eventHistory', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Performer < Model
        ...
        METADATA = {
          ...
          'function' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/med-admin-perform-function'=>['performer', 'verifier', 'witness']}, 'path'=>'Performer.function', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/med-admin-perform-function'}},
          'actor' => {'path'=>'Performer.actor', 'type'=>'CodeableReference', 'min'=>1, 'max'=>1}
        }

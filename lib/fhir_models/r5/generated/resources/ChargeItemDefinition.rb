  ...
  module R5
    class ChargeItemDefinition < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ChargeItemDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'url' => {'path'=>'ChargeItemDefinition.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
        ...
        'versionAlgorithmString' => {'path'=>'ChargeItemDefinition.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'ChargeItemDefinition.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        'name' => {'path'=>'ChargeItemDefinition.name', 'type'=>'string', 'min'=>0, 'max'=>1},
      ...
      class Applicability < Model
        ...
        METADATA = {
          ...
          'condition' => {'path'=>'Applicability.condition', 'type'=>'Expression', 'min'=>0, 'max'=>1},
          'effectivePeriod' => {'path'=>'Applicability.effectivePeriod', 'type'=>'Period', 'min'=>0, 'max'=>1},
          'relatedArtifact' => {'path'=>'Applicability.relatedArtifact', 'type'=>'RelatedArtifact', 'min'=>0, 'max'=>1}
        }
      ...
      class PropertyGroup < Model
        ...
        METADATA = {
          ...
          'priceComponent' => {'path'=>'PropertyGroup.priceComponent', 'type'=>'MonetaryComponent', 'min'=>0, 'max'=>Float::INFINITY}
        }

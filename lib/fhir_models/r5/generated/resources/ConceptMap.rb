  ...
  module R5
    class ConceptMap < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ConceptMap.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'identifier' => {'path'=>'ConceptMap.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'path'=>'ConceptMap.version', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmString' => {'path'=>'ConceptMap.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'ConceptMap.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
      ...
      class Property < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/conceptmap-property-type'=>['Coding', 'string', 'integer', 'boolean', 'dateTime', 'decimal', 'code']}, 'path'=>'Property.type', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/conceptmap-property-type'}},
          'system' => {'path'=>'Property.system', 'type'=>'canonical', 'min'=>0, 'max'=>1}
        }
      ...
      class AdditionalAttribute < Model
        ...
        METADATA = {
          'id' => {'path'=>'AdditionalAttribute.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'AdditionalAttribute.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'AdditionalAttribute.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'code' => {'path'=>'AdditionalAttribute.code', 'type'=>'code', 'min'=>1, 'max'=>1},
          'uri' => {'path'=>'AdditionalAttribute.uri', 'type'=>'uri', 'min'=>0, 'max'=>1},
          'description' => {'path'=>'AdditionalAttribute.description', 'type'=>'string', 'min'=>0, 'max'=>1},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/conceptmap-attribute-type'=>['code', 'Coding', 'string', 'boolean', 'Quantity']}, 'path'=>'AdditionalAttribute.type', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/conceptmap-attribute-type'}}
        }
      ...
      class Group < Model
        ...
        METADATA = {
          ...
          'source' => {'path'=>'Group.source', 'type'=>'canonical', 'min'=>0, 'max'=>1},
          'target' => {'path'=>'Group.target', 'type'=>'canonical', 'min'=>0, 'max'=>1},
        ...
        class Element < Model
          ...
          METADATA = {
            ...
            'valueSet' => {'path'=>'Element.valueSet', 'type'=>'canonical', 'min'=>0, 'max'=>1},
            'noMap' => {'path'=>'Element.noMap', 'type'=>'boolean', 'min'=>0, 'max'=>1},
          ...
          class Target < Model
            ...
            METADATA = {
              ...
              'valueSet' => {'path'=>'Target.valueSet', 'type'=>'canonical', 'min'=>0, 'max'=>1},
              'relationship' => {'valid_codes'=>{'http://hl7.org/fhir/concept-map-relationship'=>['related-to', 'equivalent', 'source-is-narrower-than-target', 'source-is-broader-than-target', 'not-related-to']}, 'path'=>'Target.relationship', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/concept-map-relationship'}},
              'comment' => {'path'=>'Target.comment', 'type'=>'string', 'min'=>0, 'max'=>1},
              'property' => {'path'=>'Target.property', 'type'=>'ConceptMap::Group::Element::Target::Property', 'min'=>0, 'max'=>Float::INFINITY},
            ...
            class DependsOn < Model
              ...
              METADATA = {
                ...
                'attribute' => {'path'=>'DependsOn.attribute', 'type'=>'code', 'min'=>1, 'max'=>1},
                'valueCode' => {'path'=>'DependsOn.value[x]', 'type'=>'code', 'min'=>0, 'max'=>1},
                'valueCoding' => {'path'=>'DependsOn.value[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1},
                'valueString' => {'path'=>'DependsOn.value[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
                'valueBoolean' => {'path'=>'DependsOn.value[x]', 'type'=>'boolean', 'min'=>0, 'max'=>1},
                'valueQuantity' => {'path'=>'DependsOn.value[x]', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
                'valueSet' => {'path'=>'DependsOn.valueSet', 'type'=>'canonical', 'min'=>0, 'max'=>1}
              }
        ...
        class Unmapped < Model
          ...
          METADATA = {
            ...
            'mode' => {'valid_codes'=>{'http://hl7.org/fhir/conceptmap-unmapped-mode'=>['use-source-code', 'fixed', 'other-map']}, 'path'=>'Unmapped.mode', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/conceptmap-unmapped-mode'}},
            'code' => {'path'=>'Unmapped.code', 'type'=>'code', 'min'=>0, 'max'=>1},
            'display' => {'path'=>'Unmapped.display', 'type'=>'string', 'min'=>0, 'max'=>1},
            'valueSet' => {'path'=>'Unmapped.valueSet', 'type'=>'canonical', 'min'=>0, 'max'=>1},
            'relationship' => {'valid_codes'=>{'http://hl7.org/fhir/concept-map-relationship'=>['related-to', 'equivalent', 'source-is-narrower-than-target', 'source-is-broader-than-target', 'not-related-to']}, 'path'=>'Unmapped.relationship', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/concept-map-relationship'}},
            'otherMap' => {'path'=>'Unmapped.otherMap', 'type'=>'canonical', 'min'=>0, 'max'=>1}
          }

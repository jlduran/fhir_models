module FHIR
  module R5
    class Specimen < Model
      ...
      METADATA = {
        'id' => {'path'=>'Specimen.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'Specimen.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'Specimen.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'path'=>'Specimen.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        'text' => {'path'=>'Specimen.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'Specimen.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'Specimen.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'Specimen.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'identifier' => {'path'=>'Specimen.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'accessionIdentifier' => {'path'=>'Specimen.accessionIdentifier', 'type'=>'Identifier', 'min'=>0, 'max'=>1},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/specimen-status'=>['available', 'unavailable', 'unsatisfactory', 'entered-in-error']}, 'path'=>'Specimen.status', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-status'}},
        'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0487'=>['ABS', '...', 'ACNE', 'ACNFLD', 'AIRS', 'ALL', 'AMN', 'AMP', 'ANGI', 'ARTC', 'ASERU', 'ASP', 'ATTE', 'AUTOA', 'AUTOC', 'AUTP', 'BBL', 'BCYST', 'BDY', 'BIFL', 'BITE', 'BLD', 'BLDA', 'BLDCO', 'BLDV', 'BLEB', 'BLIST', 'BOIL', 'BON', 'BOWL', 'BPH', 'BPU', 'BRN', 'BRSH', 'BRTH', 'BRUS', 'BUB', 'BULLA', 'BX', 'CALC', 'BONE', 'CARBU', 'CAT', 'CBITE', 'CDM', 'CLIPP', 'CNJT', 'CNL', 'COL', 'CONE', 'CSCR', 'CSERU', 'CSF', 'CSITE', 'CSMY', 'CST', 'CSVR', 'CTP', 'CUR', 'CVM', 'CVPS', 'CVPT', 'CYN', 'CYST', 'DBITE', 'DCS', 'DEC', 'DEION', 'DIA', 'DIAF', 'DISCHG', 'DIV', 'DRN', 'DRNG', 'DRNGP', 'DUFL', 'EARW', 'EBRUSH', 'EEYE', 'EFF', 'EFFUS', 'EFOD', 'EISO', 'ELT', 'ENVIR', 'EOS', 'EOTH', 'ESOI', 'ESOS', 'ETA', 'ETTP', 'ETTUB', 'EWHI', 'EXG', 'EXS', 'EXUDTE', 'FAW', 'FBLOOD', 'FGA', 'FIB', 'FIST', 'FLD', 'FLT', 'FLU', 'FLUID', 'FOLEY', 'FRS', 'FSCLP', 'FUR', 'GAS', 'GASA', 'GASAN', 'GASBR', 'GASD', 'GAST', 'GENL', 'GENV', 'GRAFT', 'GRAFTS', 'GRANU', 'GROSH', 'GSOL', 'GSPEC', 'GT', 'GTUBE', 'HAR', 'HBITE', 'HBLUD', 'HEMAQ', 'HEMO', 'HERNI', 'HEV', 'HIC', 'HYDC', 'IBITE', 'ICYST', 'IDC', 'IHG', 'ILEO', 'ILLEG', 'IMP', 'INCI', 'INFIL', 'INS', 'INTRD', 'ISLT', 'IT', 'IUD', 'IVCAT', 'IVFLD', 'IVTIP', 'JEJU', 'JNTFLD', 'JP', 'KELOI', 'KIDFLD', 'LAVG', 'LAVGG', 'LAVGP', 'LAVPG', 'LENS1', 'LENS2', 'LESN', 'LIQ', 'LIQO', 'LNA', 'LNV', 'LSAC', 'LYM', 'MAC', 'MAHUR', 'MAR', 'MASS', 'MBLD', 'MEC', 'MILK', 'MLK', 'MUCOS', 'MUCUS', 'NAIL', 'NASDR', 'NEDL', 'NEPH', 'NGASP', 'NGAST', 'NGS', 'NODUL', 'NSECR', 'ORH', 'ORL', 'OTH', 'PACEM', 'PAFL', 'PCFL', 'PDSIT', 'PDTS', 'PELVA', 'PENIL', 'PERIA', 'PILOC', 'PINS', 'PIS', 'PLAN', 'PLAS', 'PLB', 'PLC', 'PLEVS', 'PLR', 'PMN', 'PND', 'POL', 'POPGS', 'POPLG', 'POPLV', 'PORTA', 'PPP', 'PROST', 'PRP', 'PSC', 'PUNCT', 'PUS', 'PUSFR', 'PUST', 'QC3', 'RANDU', 'RBC', 'RBITE', 'RECT', 'RECTA', 'RENALC', 'RENC', 'RES', 'SAL', 'SCAR', 'SCLV', 'SCROA', 'SECRE', 'SER', 'SHU', 'SHUNF', 'SHUNT', 'SITE', 'SKBP', 'SKN', 'SMM', 'SMN', 'SNV', 'SPRM', 'SPRP', 'SPRPB', 'SPS', 'SPT', 'SPTC', 'SPTT', 'SPUT1', 'SPUTIN', 'SPUTSP', 'STER', 'STL', 'STONE', 'SUBMA', 'SUBMX', 'SUMP', 'SUP', 'SUTUR', 'SWGZ', 'SWT', 'TASP', 'TEAR', 'THRB', 'TISS', 'TISU', 'TLC', 'TRAC', 'TRANS', 'TSERU', 'TSTES', 'TTRA', 'TUBES', 'TUMOR', 'TZANC', 'UDENT', 'UMED', 'UR', 'URC', 'URINB', 'URINC', 'URINM', 'URINN', 'URINP', 'URNS', 'URT', 'USCOP', 'USPEC', 'USUB', 'VASTIP', 'VENT', 'VITF', 'VOM', 'WASH', 'WASI', 'WAT', 'WB', 'WBC', 'WEN', 'WICK', 'WND', 'WNDA', 'WNDD', 'WNDE', 'WORM', 'WRT', 'WWA', 'WWO', 'WWT']}, 'path'=>'Specimen.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://terminology.hl7.org/ValueSet/v2-0487'}},
        'subject' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Group', 'http://hl7.org/fhir/StructureDefinition/Device', 'http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct', 'http://hl7.org/fhir/StructureDefinition/Substance', 'http://hl7.org/fhir/StructureDefinition/Location'], 'path'=>'Specimen.subject', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'receivedTime' => {'path'=>'Specimen.receivedTime', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'parent' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Specimen'], 'path'=>'Specimen.parent', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'request' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/ServiceRequest'], 'path'=>'Specimen.request', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'combined' => {'valid_codes'=>{'http://hl7.org/fhir/specimen-combined'=>['grouped', 'pooled']}, 'path'=>'Specimen.combined', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-combined'}},
        'role' => {'valid_codes'=>{'http://hl7.org/fhir/specimen-role'=>['b', 'c', 'e', 'f', 'o', 'p', 'q', 'r', 'v']}, 'path'=>'Specimen.role', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-role'}},
        'feature' => {'path'=>'Specimen.feature', 'type'=>'Specimen::Feature', 'min'=>0, 'max'=>Float::INFINITY},
        'collection' => {'path'=>'Specimen.collection', 'type'=>'Specimen::Collection', 'min'=>0, 'max'=>1},
        'processing' => {'path'=>'Specimen.processing', 'type'=>'Specimen::Processing', 'min'=>0, 'max'=>Float::INFINITY},
        'container' => {'path'=>'Specimen.container', 'type'=>'Specimen::Container', 'min'=>0, 'max'=>Float::INFINITY},
        'condition' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0493'=>['AUT', 'CLOT', 'CON', 'COOL', 'FROZ', 'HEM', 'LIVE', 'ROOM', 'SNR', 'CFU']}, 'path'=>'Specimen.condition', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://terminology.hl7.org/ValueSet/v2-0493'}},
        'note' => {'path'=>'Specimen.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Collection < Model
        ...
        METADATA = {
          ...
          'collector' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson'], 'path'=>'Collection.collector', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          ...
          'duration' => {'path'=>'Collection.duration', 'type'=>'Duration', 'min'=>0, 'max'=>1},
          'quantity' => {'path'=>'Collection.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
          'method' => {'local_name'=>'local_method', 'valid_codes'=>{'http://snomed.info/sct'=>['129316008', '129314006', '129300006', '129304002', '129323009', '73416001', '225113003', '70777001', '386089008', '278450005']}, 'path'=>'Collection.method', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-collection-method'}},
          'device' => {'path'=>'Collection.device', 'type'=>'CodeableReference', 'min'=>0, 'max'=>1},
          'procedure' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Procedure'], 'path'=>'Collection.procedure', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          'bodySite' => {'path'=>'Collection.bodySite', 'type'=>'CodeableReference', 'min'=>0, 'max'=>1},
          'fastingStatusCodeableConcept' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0916'=>['F', 'NF', 'NG', 'FNA']}, 'path'=>'Collection.fastingStatus[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://terminology.hl7.org/ValueSet/v2-0916'}},
          'fastingStatusDuration' => {'path'=>'Collection.fastingStatus[x]', 'type'=>'Duration', 'min'=>0, 'max'=>1}
        }
      ...
      class Processing < Model
        ...
        METADATA = {
          'id' => {'path'=>'Processing.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Processing.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Processing.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'Processing.description', 'type'=>'string', 'min'=>0, 'max'=>1},
          'method' => {'local_name'=>'local_method', 'valid_codes'=>{'http://snomed.info/sct'=>['4064007', '9056003', '13374006', '18699002', '27107005', '27872000', '32989007', '43372004', '47043008', '52391000', '53355002', '56245008', '61431004', '62087002', '66910006', '69997009', '73373003', '75126003', '79453001', '80246006', '90621001', '103760009', '103761008', '104149001', '104150001', '104151002', '104166004', '104720004', '105036000', '115267000', '115597007', '116707006', '117032008', '117246001', '118130000', '118131001', '118132008', '120643004', '120647003', '120648008', '252300007', '252301006', '252302004', '313513005', '401297005', '409077008', '428995007', '433454009', '734227007', '787371004', '787372006', '787373001', '787374007', '787375008', '787376009', '787378005', '787379002', '787995009', '866036006', '866037002', '866038007', '866039004', '1230333008']}, 'path'=>'Processing.method', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-processing-method'}},
          'additive' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Substance'], 'path'=>'Processing.additive', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
          'timeDateTime' => {'path'=>'Processing.time[x]', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
          'timePeriod' => {'path'=>'Processing.time[x]', 'type'=>'Period', 'min'=>0, 'max'=>1}
        }
      ...
      class Container < Model
        ...
        METADATA = {
          ...
          'device' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Device'], 'path'=>'Container.device', 'type'=>'Reference', 'min'=>1, 'max'=>1},
          'location' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Location'], 'path'=>'Container.location', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          'specimenQuantity' => {'path'=>'Container.specimenQuantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1}
        }

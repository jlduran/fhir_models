  ...
  module R5
    class SpecimenDefinition < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'SpecimenDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
      ...
      class TypeTested < Model
        ...
        METADATA = {
          ...
          'requirement' => {'path'=>'TypeTested.requirement', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'retentionTime' => {'path'=>'TypeTested.retentionTime', 'type'=>'Duration', 'min'=>0, 'max'=>1},
          'singleUse' => {'path'=>'TypeTested.singleUse', 'type'=>'boolean', 'min'=>0, 'max'=>1},
          ...
          'testingDestination' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0074'=>['AU', 'BG', 'BLB', 'CG', 'CUS', 'CTH', 'CT', 'CH', 'CP', 'EC', 'EN', 'GE', 'HM', 'IMG', 'ICU', 'IMM', 'LAB', 'MB', 'MCB', 'MYC', 'NMS', 'NMR', 'NRS', 'OUS', 'OT', 'OTH', 'OSL', 'PAR', 'PHR', 'PAT', 'PT', 'PHY', 'PF', 'RAD', 'RX', 'RUS', 'RC', 'RT', 'SR', 'SP', 'TX', 'VUS', 'VR', 'URN', 'XRC']}, 'path'=>'TypeTested.testingDestination', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/diagnostic-service-sections'}}
        }
        ...
        class Container < Model
          ...
          METADATA = {
            ...
            'description' => {'path'=>'Container.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
            ...
            'preparation' => {'path'=>'Container.preparation', 'type'=>'markdown', 'min'=>0, 'max'=>1}
          }
          ...
          class Additive < Model
            ...
            METADATA = {
              ...
              'additiveReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/SubstanceDefinition'], 'path'=>'Additive.additive[x]', 'type'=>'Reference', 'min'=>1, 'max'=>1}
            }
        ...
        class Handling < Model
          ...
          METADATA = {
            ...
            'instruction' => {'path'=>'Handling.instruction', 'type'=>'markdown', 'min'=>0, 'max'=>1}
          }

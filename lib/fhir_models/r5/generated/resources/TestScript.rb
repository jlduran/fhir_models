  ...
  module R5
    class TestScript < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'TestScript.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'url' => {'path'=>'TestScript.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'identifier' => {'path'=>'TestScript.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'path'=>'TestScript.version', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmString' => {'path'=>'TestScript.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'TestScript.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        ...
        'scope' => {'path'=>'TestScript.scope', 'type'=>'TestScript::Scope', 'min'=>0, 'max'=>Float::INFINITY},
        'fixture' => {'path'=>'TestScript.fixture', 'type'=>'TestScript::Fixture', 'min'=>0, 'max'=>Float::INFINITY},
        'profile' => {'path'=>'TestScript.profile', 'type'=>'canonical', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Origin < Model
        ...
        METADATA = {
          ...
          'url' => {'path'=>'Origin.url', 'type'=>'url', 'min'=>0, 'max'=>1}
        }
      ...
      class Destination < Model
        ...
        METADATA = {
          ...
          'url' => {'path'=>'Destination.url', 'type'=>'url', 'min'=>0, 'max'=>1}
        }
      ...
      class Scope < Model
        ...
        METADATA = {
          ...
          'artifact' => {'path'=>'Scope.artifact', 'type'=>'canonical', 'min'=>1, 'max'=>1},
          'conformance' => {'valid_codes'=>{'http://hl7.org/fhir/testscript-scope-conformance-codes'=>['required', 'optional', 'strict']}, 'path'=>'Scope.conformance', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/testscript-scope-conformance-codes'}},
          'phase' => {'valid_codes'=>{'http://hl7.org/fhir/testscript-scope-phase-codes'=>['unit', 'integration', 'production']}, 'path'=>'Scope.phase', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/testscript-scope-phase-codes'}}
        }
        ...
        class Action < Model
          ...
          class Operation < Model
            ...
            METADATA = {
              ...
              'resource' => {'path'=>'Operation.resource', 'type'=>'uri', 'min'=>0, 'max'=>1},
          ...
          class Assert < Model
            ...
            METADATA = {
              ...
              'defaultManualCompletion' => {'valid_codes'=>{'http://hl7.org/fhir/assert-manual-completion-codes'=>['fail', 'pass', 'skip', 'stop']}, 'path'=>'Assert.defaultManualCompletion', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/assert-manual-completion-codes'}},
              ...
              'operator' => {'valid_codes'=>{'http://hl7.org/fhir/assert-operator-codes'=>['equals', 'notEquals', 'in', 'notIn', 'greaterThan', 'lessThan', 'empty', 'notEmpty', 'contains', 'notContains', 'eval', 'manualEval']}, 'path'=>'Assert.operator', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/assert-operator-codes'}},
              ...
              'requirement' => {'path'=>'Assert.requirement', 'type'=>'TestScript::Setup::Action::Assert::Requirement', 'min'=>0, 'max'=>Float::INFINITY}
            }
            ...
            class Requirement < Model
              ...
              METADATA = {
                'id' => {'path'=>'Requirement.id', 'type'=>'string', 'min'=>0, 'max'=>1},
                'extension' => {'path'=>'Requirement.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
                'modifierExtension' => {'path'=>'Requirement.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
                'linkUri' => {'path'=>'Requirement.link[x]', 'type'=>'uri', 'min'=>0, 'max'=>1},
                'linkCanonical' => {'path'=>'Requirement.link[x]', 'type'=>'canonical', 'min'=>0, 'max'=>1}
              }

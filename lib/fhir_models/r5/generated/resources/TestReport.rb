  ...
  module R5
    class TestReport < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'TestReport.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'testScript' => {'path'=>'TestReport.testScript', 'type'=>'canonical', 'min'=>1, 'max'=>1},
        ...
        class Action < Model
          ...
          class Assert < Model
            ...
            METADATA = {
              ...
              'requirement' => {'path'=>'Assert.requirement', 'type'=>'TestReport::Setup::Action::Assert::Requirement', 'min'=>0, 'max'=>Float::INFINITY}
            }

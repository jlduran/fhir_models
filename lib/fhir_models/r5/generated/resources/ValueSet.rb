  ...
  module R5
    class ValueSet < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ValueSet.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'versionAlgorithmString' => {'path'=>'ValueSet.versionAlgorithm[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'path'=>'ValueSet.versionAlgorithm[x]', 'type'=>'Coding', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        ...
        'copyrightLabel' => {'path'=>'ValueSet.copyrightLabel', 'type'=>'string', 'min'=>0, 'max'=>1},
        'approvalDate' => {'path'=>'ValueSet.approvalDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'lastReviewDate' => {'path'=>'ValueSet.lastReviewDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'effectivePeriod' => {'path'=>'ValueSet.effectivePeriod', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'topic' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/definition-use'=>['fhir-structure', 'custom-resource', 'dam', 'wire-format', 'archetype', 'template'], 'http://terminology.hl7.org/CodeSystem/definition-topic'=>['treatment', 'education', 'assessment']}, 'path'=>'ValueSet.topic', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/definition-topic'}},
        'author' => {'path'=>'ValueSet.author', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'editor' => {'path'=>'ValueSet.editor', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'reviewer' => {'path'=>'ValueSet.reviewer', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'endorser' => {'path'=>'ValueSet.endorser', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'relatedArtifact' => {'path'=>'ValueSet.relatedArtifact', 'type'=>'RelatedArtifact', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'scope' => {'path'=>'ValueSet.scope', 'type'=>'ValueSet::Scope', 'min'=>0, 'max'=>1}
      }
      ...
      class Compose < Model
        ...
        METADATA = {
          ...
          'property' => {'path'=>'Compose.property', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class Include < Model
          ...
          METADATA = {
            ...
            'copyright' => {'path'=>'Include.copyright', 'type'=>'string', 'min'=>0, 'max'=>1}
          }
          ...
          class Concept < Model
            ...
            class Designation < Model
              ...
              METADATA = {
                ...
                'language' => {'path'=>'Designation.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
                ...
                'additionalUse' => {'valid_codes'=>{'http://snomed.info/sct'=>['900000000000003001', '900000000000013009']}, 'path'=>'Designation.additionalUse', 'type'=>'Coding', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/designation-use'}},
          ...
          class Filter < Model
            ...
            METADATA = {
              ...
              'op' => {'valid_codes'=>{'http://hl7.org/fhir/filter-operator'=>['=', 'is-a', 'descendent-of', 'is-not-a', 'regex', 'in', 'not-in', 'generalizes', 'child-of', 'descendent-leaf', 'exists']}, 'path'=>'Filter.op', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/filter-operator'}},
      ...
      class Expansion < Model
        ...
        METADATA = {
          ...
          'next' => {'path'=>'Expansion.next', 'type'=>'uri', 'min'=>0, 'max'=>1},
          ...
          'property' => {'path'=>'Expansion.property', 'type'=>'ValueSet::Expansion::Property', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Contains < Model
          ...
          METADATA = {
            ...
            'property' => {'path'=>'Contains.property', 'type'=>'ValueSet::Expansion::Contains::Property', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          class Property < Model
            ...
            METADATA = {
              ...
              'subProperty' => {'path'=>'Property.subProperty', 'type'=>'ValueSet::Expansion::Contains::Property::SubProperty', 'min'=>0, 'max'=>Float::INFINITY}
            }
            ...
            class SubProperty < Model
              ...
              METADATA = {
                'id' => {'path'=>'SubProperty.id', 'type'=>'string', 'min'=>0, 'max'=>1},
                'extension' => {'path'=>'SubProperty.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
                'modifierExtension' => {'path'=>'SubProperty.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
                'code' => {'path'=>'SubProperty.code', 'type'=>'code', 'min'=>1, 'max'=>1},
                'valueCode' => {'path'=>'SubProperty.value[x]', 'type'=>'code', 'min'=>1, 'max'=>1},
                'valueCoding' => {'path'=>'SubProperty.value[x]', 'type'=>'Coding', 'min'=>1, 'max'=>1},
                'valueString' => {'path'=>'SubProperty.value[x]', 'type'=>'string', 'min'=>1, 'max'=>1},
                'valueInteger' => {'path'=>'SubProperty.value[x]', 'type'=>'integer', 'min'=>1, 'max'=>1},
                'valueBoolean' => {'path'=>'SubProperty.value[x]', 'type'=>'boolean', 'min'=>1, 'max'=>1},
                'valueDateTime' => {'path'=>'SubProperty.value[x]', 'type'=>'dateTime', 'min'=>1, 'max'=>1},
                'valueDecimal' => {'path'=>'SubProperty.value[x]', 'type'=>'decimal', 'min'=>1, 'max'=>1}
              }
      ...
      class Scope < Model
        ...
        METADATA = {
          'id' => {'path'=>'Scope.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Scope.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Scope.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'inclusionCriteria' => {'path'=>'Scope.inclusionCriteria', 'type'=>'string', 'min'=>0, 'max'=>1},
          'exclusionCriteria' => {'path'=>'Scope.exclusionCriteria', 'type'=>'string', 'min'=>0, 'max'=>1}
        }

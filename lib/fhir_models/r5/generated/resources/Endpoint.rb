module FHIR
  module R5
    class Endpoint < Model
      ...
      METADATA = {
        'id' => {'path'=>'Endpoint.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'Endpoint.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'Endpoint.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'path'=>'Endpoint.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        'text' => {'path'=>'Endpoint.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'Endpoint.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'identifier' => {'path'=>'Endpoint.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/endpoint-status'=>['active', 'suspended', 'error', 'off', 'entered-in-error']}, 'path'=>'Endpoint.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/endpoint-status'}},
        'connectionType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/endpoint-connection-type'=>['dicom-wado-rs', 'dicom-qido-rs', 'dicom-stow-rs', 'dicom-wado-uri', 'hl7-fhir-rest', 'hl7-fhir-msg', 'hl7v2-mllp', 'secure-email', 'direct-project', 'cds-hooks-service']}, 'path'=>'Endpoint.connectionType', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/endpoint-connection-type'}},
        'name' => {'path'=>'Endpoint.name', 'type'=>'string', 'min'=>0, 'max'=>1},
        'description' => {'path'=>'Endpoint.description', 'type'=>'string', 'min'=>0, 'max'=>1},
        'environmentType' => {'valid_codes'=>{'http://hl7.org/fhir/endpoint-environment'=>['prod', 'staging', 'dev', 'test', 'train']}, 'path'=>'Endpoint.environmentType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/endpoint-environment'}},
        'managingOrganization' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Endpoint.managingOrganization', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'contact' => {'path'=>'Endpoint.contact', 'type'=>'ContactPoint', 'min'=>0, 'max'=>Float::INFINITY},
        'period' => {'path'=>'Endpoint.period', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'payload' => {'path'=>'Endpoint.payload', 'type'=>'Endpoint::Payload', 'min'=>0, 'max'=>Float::INFINITY},
        'address' => {'path'=>'Endpoint.address', 'type'=>'url', 'min'=>1, 'max'=>1},
        'header' => {'path'=>'Endpoint.header', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY}
      }

  ...
  module R5
    class TestPlan < Model
      ...
      class Dependency < Model
        ...
        METADATA = {
          'id' => {'path'=>'Dependency.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Dependency.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Dependency.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'Dependency.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'predecessor' => {'path'=>'Dependency.predecessor', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class TestCase < Model
        ...
        METADATA = {
          'id' => {'path'=>'TestCase.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'TestCase.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'TestCase.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'sequence' => {'path'=>'TestCase.sequence', 'type'=>'integer', 'min'=>0, 'max'=>1},
          'scope' => {'path'=>'TestCase.scope', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
          'dependency' => {'path'=>'TestCase.dependency', 'type'=>'TestPlan::TestCase::Dependency', 'min'=>0, 'max'=>Float::INFINITY},
          'testRun' => {'path'=>'TestCase.testRun', 'type'=>'TestPlan::TestCase::TestRun', 'min'=>0, 'max'=>Float::INFINITY},
          'testData' => {'path'=>'TestCase.testData', 'type'=>'TestPlan::TestCase::TestData', 'min'=>0, 'max'=>Float::INFINITY},
          'assertion' => {'path'=>'TestCase.assertion', 'type'=>'TestPlan::TestCase::Assertion', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class TestRun < Model
          ...
          METADATA = {
            'id' => {'path'=>'TestRun.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'TestRun.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'TestRun.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'narrative' => {'path'=>'TestRun.narrative', 'type'=>'markdown', 'min'=>0, 'max'=>1},
            'script' => {'path'=>'TestRun.script', 'type'=>'TestPlan::TestCase::TestRun::Script', 'min'=>0, 'max'=>1}
          }
          ...
          class Script < Model
            ...
            METADATA = {
              'id' => {'path'=>'Script.id', 'type'=>'string', 'min'=>0, 'max'=>1},
              'extension' => {'path'=>'Script.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'modifierExtension' => {'path'=>'Script.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'language' => {'path'=>'Script.language', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
              'sourceString' => {'path'=>'Script.source[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
              'sourceReference' => {'path'=>'Script.source[x]', 'type'=>'Reference', 'min'=>0, 'max'=>1}
            }
        ...
        class TestData < Model
          ...
          METADATA = {
            'id' => {'path'=>'TestData.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'TestData.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'TestData.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'path'=>'TestData.type', 'type'=>'Coding', 'min'=>1, 'max'=>1},
            'content' => {'path'=>'TestData.content', 'type'=>'Reference', 'min'=>0, 'max'=>1},
            'sourceString' => {'path'=>'TestData.source[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
            'sourceReference' => {'path'=>'TestData.source[x]', 'type'=>'Reference', 'min'=>0, 'max'=>1}
          }
        ...
        class Assertion < Model
          ...
          METADATA = {
            'id' => {'path'=>'Assertion.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'Assertion.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'Assertion.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'path'=>'Assertion.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY},
            'object' => {'path'=>'Assertion.object', 'type'=>'CodeableReference', 'min'=>0, 'max'=>Float::INFINITY},
            'result' => {'path'=>'Assertion.result', 'type'=>'CodeableReference', 'min'=>0, 'max'=>Float::INFINITY}
          }

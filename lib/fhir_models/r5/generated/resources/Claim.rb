  ...
  module R5
    class Claim < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'Claim.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'traceNumber' => {'path'=>'Claim.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'enterer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson'], 'path'=>'Claim.enterer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'insurer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Claim.insurer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'provider' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Claim.provider', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'priority' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/processpriority'=>['stat', 'normal', 'deferred']}, 'path'=>'Claim.priority', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/process-priority'}},
        ...
        'encounter' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Encounter'], 'path'=>'Claim.encounter', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'facility' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Location', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Claim.facility', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'diagnosisRelatedGroup' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-diagnosisrelatedgroup'=>['100', '101', '300', '400']}, 'path'=>'Claim.diagnosisRelatedGroup', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-diagnosisrelatedgroup'}},
        'event' => {'path'=>'Claim.event', 'type'=>'Claim::Event', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'insurance' => {'path'=>'Claim.insurance', 'type'=>'Claim::Insurance', 'min'=>0, 'max'=>Float::INFINITY},
        'accident' => {'path'=>'Claim.accident', 'type'=>'Claim::Accident', 'min'=>0, 'max'=>1},
        'patientPaid' => {'path'=>'Claim.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
      ...
      class Item < Model
        ...
        METADATA = {
          ...
          'bodySite' => {'path'=>'Item.bodySite', 'type'=>'Claim::Item::BodySite', 'min'=>0, 'max'=>Float::INFINITY},

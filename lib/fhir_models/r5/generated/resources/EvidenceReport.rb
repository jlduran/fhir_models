  ...
  module R5
    class EvidenceReport < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'EvidenceReport.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/evidence-report-type'=>['classification', 'search-results', 'resources-compiled', 'text-structured']}, 'path'=>'EvidenceReport.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/evidence-report-type'}},
      ...
      class RelatesTo < Model
        ...
        METADATA = {
          ...
          'target' => {'path'=>'RelatesTo.target', 'type'=>'EvidenceReport::RelatesTo::Target', 'min'=>1, 'max'=>1}
        }
        ...
        class Target < Model
          ...
          METADATA = {
            ...
            'url' => {'path'=>'Target.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
            'identifier' => {'path'=>'Target.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>1},
            'display' => {'path'=>'Target.display', 'type'=>'markdown', 'min'=>0, 'max'=>1},
            'resource' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'path'=>'Target.resource', 'type'=>'Reference', 'min'=>0, 'max'=>1}
          }
      ...
      class Section < Model
        ...
        METADATA = {
          ...
          'author' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson', 'http://hl7.org/fhir/StructureDefinition/Device', 'http://hl7.org/fhir/StructureDefinition/Group', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Section.author', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},

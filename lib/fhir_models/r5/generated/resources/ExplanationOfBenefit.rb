  ...
  module R5
    class ExplanationOfBenefit < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ExplanationOfBenefit.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'traceNumber' => {'path'=>'ExplanationOfBenefit.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'enterer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson'], 'path'=>'ExplanationOfBenefit.enterer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'insurer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'ExplanationOfBenefit.insurer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'provider' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'ExplanationOfBenefit.provider', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'priority' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/processpriority'=>['stat', 'normal', 'deferred']}, 'path'=>'ExplanationOfBenefit.priority', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/process-priority'}},
        ...
        'event' => {'path'=>'ExplanationOfBenefit.event', 'type'=>'ExplanationOfBenefit::Event', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'encounter' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Encounter'], 'path'=>'ExplanationOfBenefit.encounter', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'facility' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Location', 'http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'ExplanationOfBenefit.facility', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'outcome' => {'valid_codes'=>{'http://hl7.org/fhir/claim-outcome'=>['queued', 'complete', 'error', 'partial']}, 'path'=>'ExplanationOfBenefit.outcome', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-outcome'}},
        'decision' => {'valid_codes'=>{'http://hl7.org/fhir/claim-decision'=>['denied', 'approved', 'partial', 'pending']}, 'path'=>'ExplanationOfBenefit.decision', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-decision'}},
        ...
        'diagnosisRelatedGroup' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-diagnosisrelatedgroup'=>['100', '101', '300', '400']}, 'path'=>'ExplanationOfBenefit.diagnosisRelatedGroup', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-diagnosisrelatedgroup'}},
        ...
        'insurance' => {'path'=>'ExplanationOfBenefit.insurance', 'type'=>'ExplanationOfBenefit::Insurance', 'min'=>0, 'max'=>Float::INFINITY},
        'accident' => {'path'=>'ExplanationOfBenefit.accident', 'type'=>'ExplanationOfBenefit::Accident', 'min'=>0, 'max'=>1},
        'patientPaid' => {'path'=>'ExplanationOfBenefit.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
      ...
      class Event < Model
        ...
        METADATA = {
          'id' => {'path'=>'Event.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Event.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Event.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/datestype'=>['card-issued', 'claim-received', 'service-expected']}, 'path'=>'Event.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/datestype'}},
          'whenDateTime' => {'path'=>'Event.when[x]', 'type'=>'dateTime', 'min'=>1, 'max'=>1},
          'whenPeriod' => {'path'=>'Event.when[x]', 'type'=>'Period', 'min'=>1, 'max'=>1}
        }
      ...
      class CareTeam < Model
        ...
        METADATA = {
          ...
          'specialty' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-providerqualification'=>['311405', '604215', '604210']}, 'path'=>'CareTeam.specialty', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/provider-qualification'}}
        }
      ...
      class SupportingInfo < Model
        ...
        METADATA = {
          ...
          'valueIdentifier' => {'path'=>'SupportingInfo.value[x]', 'type'=>'Identifier', 'min'=>0, 'max'=>1},
      ...
      class Diagnosis < Model
        ...
        METADATA = {
          ...
          'onAdmission' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-diagnosis-on-admission'=>['yes', 'no', 'unknown']}, 'path'=>'Diagnosis.onAdmission', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-diagnosis-on-admission'}}
        }
      ...
      class Accident < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>['MVA', 'SCHOOL', 'SPT', 'WPA', '_ActPatientSafetyIncidentCode']}, 'path'=>'Accident.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://terminology.hl7.org/ValueSet/v3-ActIncidentCode'}},
      ...
      class Item < Model
        ...
        METADATA = {
          ...
          'traceNumber' => {'path'=>'Item.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
          'revenue' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-revenue-center'=>['0010', '0011', '1001']}, 'path'=>'Item.revenue', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-revenue-center'}},
          ...
          'productOrServiceEnd' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'Item.productOrServiceEnd', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
          'request' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DeviceRequest', 'http://hl7.org/fhir/StructureDefinition/MedicationRequest', 'http://hl7.org/fhir/StructureDefinition/NutritionOrder', 'http://hl7.org/fhir/StructureDefinition/ServiceRequest', 'http://hl7.org/fhir/StructureDefinition/SupplyRequest', 'http://hl7.org/fhir/StructureDefinition/VisionPrescription'], 'path'=>'Item.request', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          'patientPaid' => {'path'=>'Item.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
          ...
          'tax' => {'path'=>'Item.tax', 'type'=>'Money', 'min'=>0, 'max'=>1},
          ...
          'bodySite' => {'path'=>'Item.bodySite', 'type'=>'ExplanationOfBenefit::Item::BodySite', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          'reviewOutcome' => {'path'=>'Item.reviewOutcome', 'type'=>'ExplanationOfBenefit::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
        ...
        class BodySite < Model
          ...
          METADATA = {
            'id' => {'path'=>'BodySite.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'BodySite.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'BodySite.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'site' => {'path'=>'BodySite.site', 'type'=>'CodeableReference', 'min'=>1, 'max'=>Float::INFINITY},
            'subSite' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/FDI-surface'=>['M', 'O', 'I', 'D', 'B', 'V', 'L', 'MO', 'DO', 'DI', 'MOD']}, 'path'=>'BodySite.subSite', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/surface'}}
          }
        ...
        class ReviewOutcome < Model
          ...
          METADATA = {
            'id' => {'path'=>'ReviewOutcome.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'ReviewOutcome.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'ReviewOutcome.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'decision' => {'valid_codes'=>{'http://hl7.org/fhir/claim-decision'=>['denied', 'approved', 'partial', 'pending']}, 'path'=>'ReviewOutcome.decision', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-decision'}},
            'reason' => {'valid_codes'=>{'http://hl7.org/fhir/claim-decision-reason'=>['0001', '0002', '0003', '0004', '0005']}, 'path'=>'ReviewOutcome.reason', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-decision-reason'}},
            'preAuthRef' => {'path'=>'ReviewOutcome.preAuthRef', 'type'=>'string', 'min'=>0, 'max'=>1},
            'preAuthPeriod' => {'path'=>'ReviewOutcome.preAuthPeriod', 'type'=>'Period', 'min'=>0, 'max'=>1}
          }
        ...
        class Adjudication < Model
          ...
          METADATA = {
            ...
            'quantity' => {'path'=>'Adjudication.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1}
          }
        ...
        class Detail < Model
          ...
          METADATA = {
            ...
            'traceNumber' => {'path'=>'Detail.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
            'revenue' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-revenue-center'=>['0010', '0011', '1001']}, 'path'=>'Detail.revenue', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-revenue-center'}},
            ...
            'productOrService' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'Detail.productOrService', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
            'productOrServiceEnd' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'Detail.productOrServiceEnd', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
            ...
            'patientPaid' => {'path'=>'Detail.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
            ...
            'tax' => {'path'=>'Detail.tax', 'type'=>'Money', 'min'=>0, 'max'=>1},
            ...
            'reviewOutcome' => {'path'=>'Detail.reviewOutcome', 'type'=>'ExplanationOfBenefit::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
          ...
          class SubDetail < Model
            ...
            METADATA = {
              ...
              'traceNumber' => {'path'=>'SubDetail.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
              'revenue' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-revenue-center'=>['0010', '0011', '1001']}, 'path'=>'SubDetail.revenue', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-revenue-center'}},
              ...
              'productOrService' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'SubDetail.productOrService', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
              'productOrServiceEnd' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'SubDetail.productOrServiceEnd', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
              ...
              'patientPaid' => {'path'=>'SubDetail.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
              ...
              'tax' => {'path'=>'SubDetail.tax', 'type'=>'Money', 'min'=>0, 'max'=>1},
              ...
              'reviewOutcome' => {'path'=>'SubDetail.reviewOutcome', 'type'=>'ExplanationOfBenefit::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
      ...
      class AddItem < Model
        ...
        METADATA = {
          ...
          'traceNumber' => {'path'=>'AddItem.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          'revenue' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-revenue-center'=>['0010', '0011', '1001']}, 'path'=>'AddItem.revenue', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-revenue-center'}},
          'productOrService' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'AddItem.productOrService', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
          'productOrServiceEnd' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-USCLS'=>['1101', '1102', '1103', '1201', '1205', '2101', '2102', '2141', '2601', '11101', '11102', '11103', '11104', '21211', '21212', '27211', '67211', '99111', '99333', '99555']}, 'path'=>'AddItem.productOrServiceEnd', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/service-uscls'}},
          'request' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DeviceRequest', 'http://hl7.org/fhir/StructureDefinition/MedicationRequest', 'http://hl7.org/fhir/StructureDefinition/NutritionOrder', 'http://hl7.org/fhir/StructureDefinition/ServiceRequest', 'http://hl7.org/fhir/StructureDefinition/SupplyRequest', 'http://hl7.org/fhir/StructureDefinition/VisionPrescription'], 'path'=>'AddItem.request', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          'patientPaid' => {'path'=>'AddItem.patientPaid', 'type'=>'Money', 'min'=>0, 'max'=>1},
          ...
          'tax' => {'path'=>'AddItem.tax', 'type'=>'Money', 'min'=>0, 'max'=>1},
          'net' => {'path'=>'AddItem.net', 'type'=>'Money', 'min'=>0, 'max'=>1},
          'bodySite' => {'path'=>'AddItem.bodySite', 'type'=>'ExplanationOfBenefit::AddItem::BodySite', 'min'=>0, 'max'=>Float::INFINITY},
          'noteNumber' => {'path'=>'AddItem.noteNumber', 'type'=>'positiveInt', 'min'=>0, 'max'=>Float::INFINITY},
          'reviewOutcome' => {'path'=>'AddItem.reviewOutcome', 'type'=>'ExplanationOfBenefit::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
      ...
      class ProcessNote < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/note-type'=>['display', 'print', 'printoper']}, 'path'=>'ProcessNote.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/note-type'}},
          'text' => {'path'=>'ProcessNote.text', 'type'=>'string', 'min'=>0, 'max'=>1},
          'language' => {'path'=>'ProcessNote.language', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}}
        }

  ...
  module R5
    class Parameters < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'Parameters.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
      ...
      class Parameter < Model
        ...
        METADATA = {
          ...
          'valueInteger64' => {'path'=>'Parameter.value[x]', 'type'=>'integer64', 'min'=>0, 'max'=>1},
          ...
          'valueCodeableReference' => {'path'=>'Parameter.value[x]', 'type'=>'CodeableReference', 'min'=>0, 'max'=>1},
          ...
          'valueRatioRange' => {'path'=>'Parameter.value[x]', 'type'=>'RatioRange', 'min'=>0, 'max'=>1},
          ...
          'valueAvailability' => {'path'=>'Parameter.value[x]', 'type'=>'Availability', 'min'=>0, 'max'=>1},
          'valueExtendedContactDetail' => {'path'=>'Parameter.value[x]', 'type'=>'ExtendedContactDetail', 'min'=>0, 'max'=>1},

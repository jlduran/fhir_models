  ...
  module R5
    class ImmunizationRecommendation < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ImmunizationRecommendation.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
      ...
      class Recommendation < Model
        ...
        METADATA = {
          ...
          'description' => {'path'=>'Recommendation.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'series' => {'path'=>'Recommendation.series', 'type'=>'string', 'min'=>0, 'max'=>1},
          'doseNumber' => {'path'=>'Recommendation.doseNumber', 'type'=>'string', 'min'=>0, 'max'=>1},
          'seriesDoses' => {'path'=>'Recommendation.seriesDoses', 'type'=>'string', 'min'=>0, 'max'=>1},

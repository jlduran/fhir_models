  ...
  module R5
    class SubstanceDefinition < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'SubstanceDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'characterization' => {'path'=>'SubstanceDefinition.characterization', 'type'=>'SubstanceDefinition::Characterization', 'min'=>0, 'max'=>Float::INFINITY},
        'property' => {'path'=>'SubstanceDefinition.property', 'type'=>'SubstanceDefinition::Property', 'min'=>0, 'max'=>Float::INFINITY},
        'referenceInformation' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/SubstanceReferenceInformation'], 'path'=>'SubstanceDefinition.referenceInformation', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'nucleicAcid' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/SubstanceNucleicAcid'], 'path'=>'SubstanceDefinition.nucleicAcid', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'polymer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/SubstancePolymer'], 'path'=>'SubstanceDefinition.polymer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'protein' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/SubstanceProtein'], 'path'=>'SubstanceDefinition.protein', 'type'=>'Reference', 'min'=>0, 'max'=>1},
      ...
      class Characterization < Model
        ...
        METADATA = {
          'id' => {'path'=>'Characterization.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Characterization.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Characterization.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'technique' => {'valid_codes'=>{'http://hl7.org/fhir/substance-structure-technique'=>['X-Ray', 'HPLC', 'NMR', 'PeptideMapping', 'LigandBindingAssay']}, 'path'=>'Characterization.technique', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/substance-structure-technique'}},
          'form' => {'valid_codes'=>{'http://hl7.org/fhir/substance-form'=>['salt', 'base']}, 'path'=>'Characterization.form', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/substance-form'}},
          'description' => {'path'=>'Characterization.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
          'file' => {'path'=>'Characterization.file', 'type'=>'Attachment', 'min'=>0, 'max'=>Float::INFINITY}
        }
      ...
      class Name < Model
        ...
        METADATA = {
          ...
          'language' => {'path'=>'Name.language', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},

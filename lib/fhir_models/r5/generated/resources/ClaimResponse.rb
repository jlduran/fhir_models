  ...
  module R5
    class ClaimResponse < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'ClaimResponse.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'traceNumber' => {'path'=>'ClaimResponse.traceNumber', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'insurer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'ClaimResponse.insurer', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'outcome' => {'valid_codes'=>{'http://hl7.org/fhir/claim-outcome'=>['queued', 'complete', 'error', 'partial']}, 'path'=>'ClaimResponse.outcome', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-outcome'}},
        'decision' => {'valid_codes'=>{'http://hl7.org/fhir/claim-decision'=>['denied', 'approved', 'partial', 'pending']}, 'path'=>'ClaimResponse.decision', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/claim-decision'}},
        ...
        'event' => {'path'=>'ClaimResponse.event', 'type'=>'ClaimResponse::Event', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'encounter' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Encounter'], 'path'=>'ClaimResponse.encounter', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'diagnosisRelatedGroup' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/ex-diagnosisrelatedgroup'=>['100', '101', '300', '400']}, 'path'=>'ClaimResponse.diagnosisRelatedGroup', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/ex-diagnosisrelatedgroup'}},
      ...
      class Item < Model
        ...
        METADATA = {
          ...
          'reviewOutcome' => {'path'=>'Item.reviewOutcome', 'type'=>'ClaimResponse::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
          'adjudication' => {'path'=>'Item.adjudication', 'type'=>'ClaimResponse::Item::Adjudication', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Detail < Model
          ...
          METADATA = {
            ...
            'reviewOutcome' => {'path'=>'Detail.reviewOutcome', 'type'=>'ClaimResponse::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
            'adjudication' => {'path'=>'Detail.adjudication', 'type'=>'ClaimResponse::Item::Adjudication', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          class SubDetail < Model
            ...
            METADATA = {
              ...
              'reviewOutcome' => {'path'=>'SubDetail.reviewOutcome', 'type'=>'ClaimResponse::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
      ...
      class AddItem < Model
        ...
        METADATA = {
          ...
          'bodySite' => {'path'=>'AddItem.bodySite', 'type'=>'ClaimResponse::AddItem::BodySite', 'min'=>0, 'max'=>Float::INFINITY},
          'noteNumber' => {'path'=>'AddItem.noteNumber', 'type'=>'positiveInt', 'min'=>0, 'max'=>Float::INFINITY},
          'reviewOutcome' => {'path'=>'AddItem.reviewOutcome', 'type'=>'ClaimResponse::Item::ReviewOutcome', 'min'=>0, 'max'=>1},
          'adjudication' => {'path'=>'AddItem.adjudication', 'type'=>'ClaimResponse::Item::Adjudication', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Error < Model
        ...
        METADATA = {
          ...
          'expression' => {'path'=>'Error.expression', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY}
        }

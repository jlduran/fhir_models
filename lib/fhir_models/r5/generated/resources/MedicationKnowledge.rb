  ...
  module R5
    class MedicationKnowledge < Model
      ...
      class RelatedMedicationKnowledge < Model
        ...
        METADATA = {
          'id' => {'path'=>'RelatedMedicationKnowledge.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'RelatedMedicationKnowledge.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'RelatedMedicationKnowledge.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'path'=>'RelatedMedicationKnowledge.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'reference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicationKnowledge'], 'path'=>'RelatedMedicationKnowledge.reference', 'type'=>'Reference', 'min'=>1, 'max'=>Float::INFINITY}
        }
      ...
      class Monograph < Model
        ...
        METADATA = {
          'id' => {'path'=>'Monograph.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Monograph.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Monograph.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'path'=>'Monograph.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'source' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DocumentReference'], 'path'=>'Monograph.source', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class Cost < Model
        ...
        METADATA = {
          ...
          'effectiveDate' => {'path'=>'Cost.effectiveDate', 'type'=>'Period', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'path'=>'Cost.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'source' => {'path'=>'Cost.source', 'type'=>'string', 'min'=>0, 'max'=>1},
          'costMoney' => {'path'=>'Cost.cost[x]', 'type'=>'Money', 'min'=>1, 'max'=>1},
          'costCodeableConcept' => {'valid_codes'=>{'http://hl7.org/fhir/medication-cost-category'=>['banda', 'bandb']}, 'path'=>'Cost.cost[x]', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-cost-category'}}
        }
      ...
      class MonitoringProgram < Model
        ...
        METADATA = {
          'id' => {'path'=>'MonitoringProgram.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'MonitoringProgram.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'MonitoringProgram.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'path'=>'MonitoringProgram.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'name' => {'path'=>'MonitoringProgram.name', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class IndicationGuideline < Model
        ...
        METADATA = {
          'id' => {'path'=>'IndicationGuideline.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'IndicationGuideline.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'IndicationGuideline.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'indication' => {'path'=>'IndicationGuideline.indication', 'type'=>'CodeableReference', 'min'=>0, 'max'=>Float::INFINITY},
          'dosingGuideline' => {'path'=>'IndicationGuideline.dosingGuideline', 'type'=>'MedicationKnowledge::IndicationGuideline::DosingGuideline', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class DosingGuideline < Model
          ...
          METADATA = {
            'id' => {'path'=>'DosingGuideline.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'DosingGuideline.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'DosingGuideline.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'treatmentIntent' => {'path'=>'DosingGuideline.treatmentIntent', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
            'dosage' => {'path'=>'DosingGuideline.dosage', 'type'=>'MedicationKnowledge::IndicationGuideline::DosingGuideline::Dosage', 'min'=>0, 'max'=>Float::INFINITY},
            'administrationTreatment' => {'path'=>'DosingGuideline.administrationTreatment', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
            'patientCharacteristic' => {'path'=>'DosingGuideline.patientCharacteristic', 'type'=>'MedicationKnowledge::IndicationGuideline::DosingGuideline::PatientCharacteristic', 'min'=>0, 'max'=>Float::INFINITY}
          }
          ...
          class Dosage < Model
            ...
            METADATA = {
              'id' => {'path'=>'Dosage.id', 'type'=>'string', 'min'=>0, 'max'=>1},
              'extension' => {'path'=>'Dosage.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'modifierExtension' => {'path'=>'Dosage.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'type' => {'path'=>'Dosage.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
              'dosage' => {'path'=>'Dosage.dosage', 'type'=>'Dosage', 'min'=>1, 'max'=>Float::INFINITY}
            }
          ...
          class PatientCharacteristic < Model
            ...
            METADATA = {
              'id' => {'path'=>'PatientCharacteristic.id', 'type'=>'string', 'min'=>0, 'max'=>1},
              'extension' => {'path'=>'PatientCharacteristic.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'modifierExtension' => {'path'=>'PatientCharacteristic.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
              'type' => {'path'=>'PatientCharacteristic.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
              'valueCodeableConcept' => {'path'=>'PatientCharacteristic.value[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
              'valueQuantity' => {'path'=>'PatientCharacteristic.value[x]', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
              'valueRange' => {'path'=>'PatientCharacteristic.value[x]', 'type'=>'Range', 'min'=>0, 'max'=>1}
            }
      ...
      class MedicineClassification < Model
        ...
        METADATA = {
          'id' => {'path'=>'MedicineClassification.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'MedicineClassification.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'MedicineClassification.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'path'=>'MedicineClassification.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'sourceString' => {'path'=>'MedicineClassification.source[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
          'sourceUri' => {'path'=>'MedicineClassification.source[x]', 'type'=>'uri', 'min'=>0, 'max'=>1},
          'classification' => {'path'=>'MedicineClassification.classification', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY}
        }
      ...
      class Packaging < Model
        ...
        METADATA = {
          ...
          'cost' => {'path'=>'Packaging.cost', 'type'=>'MedicationKnowledge::Cost', 'min'=>0, 'max'=>Float::INFINITY},
          'packagedProduct' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/PackagedProductDefinition'], 'path'=>'Packaging.packagedProduct', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class StorageGuideline < Model
        ...
        METADATA = {
          'id' => {'path'=>'StorageGuideline.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'StorageGuideline.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'StorageGuideline.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'reference' => {'path'=>'StorageGuideline.reference', 'type'=>'uri', 'min'=>0, 'max'=>1},
          'note' => {'path'=>'StorageGuideline.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
          'stabilityDuration' => {'path'=>'StorageGuideline.stabilityDuration', 'type'=>'Duration', 'min'=>0, 'max'=>1},
          'environmentalSetting' => {'path'=>'StorageGuideline.environmentalSetting', 'type'=>'MedicationKnowledge::StorageGuideline::EnvironmentalSetting', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class EnvironmentalSetting < Model
          ...
          METADATA = {
            'id' => {'path'=>'EnvironmentalSetting.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'EnvironmentalSetting.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'EnvironmentalSetting.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'path'=>'EnvironmentalSetting.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
            'valueQuantity' => {'path'=>'EnvironmentalSetting.value[x]', 'type'=>'Quantity', 'min'=>1, 'max'=>1},
            'valueRange' => {'path'=>'EnvironmentalSetting.value[x]', 'type'=>'Range', 'min'=>1, 'max'=>1},
            'valueCodeableConcept' => {'path'=>'EnvironmentalSetting.value[x]', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1}
          }
      ...
      class Regulatory < Model
        ...
        METADATA = {
          'id' => {'path'=>'Regulatory.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Regulatory.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Regulatory.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'regulatoryAuthority' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'Regulatory.regulatoryAuthority', 'type'=>'Reference', 'min'=>1, 'max'=>1},
          'substitution' => {'path'=>'Regulatory.substitution', 'type'=>'MedicationKnowledge::Regulatory::Substitution', 'min'=>0, 'max'=>Float::INFINITY},
          'schedule' => {'path'=>'Regulatory.schedule', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY},
          'maxDispense' => {'path'=>'Regulatory.maxDispense', 'type'=>'MedicationKnowledge::Regulatory::MaxDispense', 'min'=>0, 'max'=>1}
        }
        ...
        class Substitution < Model
          ...
          METADATA = {
            ...
            'type' => {'path'=>'Substitution.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
            'allowed' => {'path'=>'Substitution.allowed', 'type'=>'boolean', 'min'=>1, 'max'=>1}
          }
        ...
        class MaxDispense < Model
          ...
          METADATA = {
            'id' => {'path'=>'MaxDispense.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'MaxDispense.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'MaxDispense.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'quantity' => {'path'=>'MaxDispense.quantity', 'type'=>'Quantity', 'min'=>1, 'max'=>1},
            'period' => {'path'=>'MaxDispense.period', 'type'=>'Duration', 'min'=>0, 'max'=>1}
          }
      ...
      class Definitional < Model
        ...
        class Ingredient < Model
          ...
          METADATA = {
            ...
            'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-RoleClass'=>['INGR', 'ACTI', 'ACTIB', 'ACTIM', 'ACTIR', 'ADJV', 'ADTV', 'BASE', 'CNTM', 'IACT', 'COLR', 'FLVR', 'PRSV', 'STBL', 'MECH']}, 'path'=>'Ingredient.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://terminology.hl7.org/ValueSet/v3-RoleClassIngredientEntity'}},
            'strengthRatio' => {'path'=>'Ingredient.strength[x]', 'type'=>'Ratio', 'min'=>0, 'max'=>1},
            'strengthCodeableConcept' => {'valid_codes'=>{'http://hl7.org/fhir/CodeSystem/medication-ingredientstrength'=>['qs', 'trace']}, 'path'=>'Ingredient.strength[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-ingredientstrength'}},
            'strengthQuantity' => {'path'=>'Ingredient.strength[x]', 'type'=>'Quantity', 'min'=>0, 'max'=>1}
          }
        ...
        class DrugCharacteristic < Model
          ...
          METADATA = {
            'id' => {'path'=>'DrugCharacteristic.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'DrugCharacteristic.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'DrugCharacteristic.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/medicationknowledge-characteristic'=>['imprintcd', 'size', 'shape', 'color', 'coating', 'scoring', 'logo', 'image']}, 'path'=>'DrugCharacteristic.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medicationknowledge-characteristic'}},
            'valueCodeableConcept' => {'path'=>'DrugCharacteristic.value[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
            'valueString' => {'path'=>'DrugCharacteristic.value[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
            'valueQuantity' => {'path'=>'DrugCharacteristic.value[x]', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
            'valueBase64Binary' => {'path'=>'DrugCharacteristic.value[x]', 'type'=>'base64Binary', 'min'=>0, 'max'=>1},
            'valueAttachment' => {'path'=>'DrugCharacteristic.value[x]', 'type'=>'Attachment', 'min'=>0, 'max'=>1}
          }

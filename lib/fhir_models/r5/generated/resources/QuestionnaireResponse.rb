  ...
  module R5
    class QuestionnaireResponse < Model
      ...
      METADATA = {
        ...
        'language' => {'path'=>'QuestionnaireResponse.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'identifier' => {'path'=>'QuestionnaireResponse.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'questionnaire' => {'path'=>'QuestionnaireResponse.questionnaire', 'type'=>'canonical', 'min'=>1, 'max'=>1},
        ...
        'source' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Device', 'http://hl7.org/fhir/StructureDefinition/Organization', 'http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson'], 'path'=>'QuestionnaireResponse.source', 'type'=>'Reference', 'min'=>0, 'max'=>1},
      ...
      class Item < Model
        ...
        class Answer < Model
          ...
          METADATA = {
            ...
            'valueCoding' => {'path'=>'Answer.value[x]', 'type'=>'Coding', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/questionnaire-answers'}},

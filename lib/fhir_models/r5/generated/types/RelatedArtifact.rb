  ...
  module R5
    class RelatedArtifact < Model
      ...
      METADATA = {
        ...
        'resourceReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'path'=>'RelatedArtifact.resourceReference', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'publicationStatus' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'path'=>'RelatedArtifact.publicationStatus', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        'publicationDate' => {'path'=>'RelatedArtifact.publicationDate', 'type'=>'date', 'min'=>0, 'max'=>1}
      }

    ...
    class AdministrableProductDefinition < Model
      ...
      class Property < Model
        ...
        METADATA = {
          ...
          'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'path'=>'Property.status', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}}
        }
      ...
      class RouteOfAdministration < Model
        ...
        METADATA = {
          ...
          'targetSpecies' => {'path'=>'RouteOfAdministration.targetSpecies', 'type'=>'AdministrableProductDefinition::RouteOfAdministration::TargetSpecies', 'min'=>0, 'max'=>Float::INFINITY}
        }

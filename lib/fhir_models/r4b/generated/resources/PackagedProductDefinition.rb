module FHIR
  module R4B
    class PackagedProductDefinition < Model
      ...
      METADATA = {
        'id' => {'path'=>'PackagedProductDefinition.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'PackagedProductDefinition.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'PackagedProductDefinition.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'PackagedProductDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        'text' => {'path'=>'PackagedProductDefinition.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'PackagedProductDefinition.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'PackagedProductDefinition.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'PackagedProductDefinition.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'identifier' => {'path'=>'PackagedProductDefinition.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'name' => {'path'=>'PackagedProductDefinition.name', 'type'=>'string', 'min'=>0, 'max'=>1},
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/package-type'=>['MedicinalProductPack', 'RawMaterialPackage', 'Shipping-TransportContainer']}, 'path'=>'PackagedProductDefinition.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/package-type'}},
        'packageFor' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProductDefinition'], 'path'=>'PackagedProductDefinition.packageFor', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'path'=>'PackagedProductDefinition.status', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        'statusDate' => {'path'=>'PackagedProductDefinition.statusDate', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'containedItemQuantity' => {'path'=>'PackagedProductDefinition.containedItemQuantity', 'type'=>'Quantity', 'min'=>0, 'max'=>Float::INFINITY},
        'description' => {'path'=>'PackagedProductDefinition.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'legalStatusOfSupply' => {'path'=>'PackagedProductDefinition.legalStatusOfSupply', 'type'=>'PackagedProductDefinition::LegalStatusOfSupply', 'min'=>0, 'max'=>Float::INFINITY},
        'marketingStatus' => {'path'=>'PackagedProductDefinition.marketingStatus', 'type'=>'MarketingStatus', 'min'=>0, 'max'=>Float::INFINITY},
        'characteristic' => {'valid_codes'=>{'http://hl7.org/fhir/package-characteristic'=>['HospitalPack', 'NursePrescribable', 'CalendarPack']}, 'path'=>'PackagedProductDefinition.characteristic', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/package-characteristic'}},
        'copackagedIndicator' => {'path'=>'PackagedProductDefinition.copackagedIndicator', 'type'=>'boolean', 'min'=>0, 'max'=>1},
        'manufacturer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'PackagedProductDefinition.manufacturer', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'package' => {'path'=>'PackagedProductDefinition.package', 'type'=>'PackagedProductDefinition::Package', 'min'=>0, 'max'=>1}
      }
      ...
      class Package < Model
        ...
        class ShelfLifeStorage < Model
          ...
          METADATA = {
            'id' => {'path'=>'ShelfLifeStorage.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'ShelfLifeStorage.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'ShelfLifeStorage.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'path'=>'ShelfLifeStorage.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
            'periodDuration' => {'path'=>'ShelfLifeStorage.period[x]', 'type'=>'Duration', 'min'=>0, 'max'=>1},
            'periodString' => {'path'=>'ShelfLifeStorage.period[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
            'specialPrecautionsForStorage' => {'path'=>'ShelfLifeStorage.specialPrecautionsForStorage', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY}
          }
        ...
        class ContainedItem < Model
          ...
          METADATA = {
            'id' => {'path'=>'ContainedItem.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'ContainedItem.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'ContainedItem.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'item' => {'path'=>'ContainedItem.item', 'type'=>'CodeableReference', 'min'=>1, 'max'=>1},
            'amount' => {'path'=>'ContainedItem.amount', 'type'=>'Quantity', 'min'=>0, 'max'=>1}
          }

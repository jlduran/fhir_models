    ...
    class Specimen < Model
      ...
      class Processing < Model
        ...
        METADATA = {
          ...
          'procedure' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0373'=>['LDLP', 'RECA', 'DEFB', 'ACID', 'NEUT', 'ALK', 'FILT', 'UFIL']}, 'path'=>'Processing.procedure', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-processing-procedure'}},

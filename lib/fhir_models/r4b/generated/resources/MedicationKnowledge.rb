  ...
  module R4B
    class MedicationKnowledge < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'MedicationKnowledge.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        ...
        'administrationGuidelines' => {'path'=>'MedicationKnowledge.administrationGuidelines', 'type'=>'MedicationKnowledge::AdministrationGuidelines', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'packaging' => {'path'=>'MedicationKnowledge.packaging', 'type'=>'MedicationKnowledge::Packaging', 'min'=>0, 'max'=>1},
        'drugCharacteristic' => {'path'=>'MedicationKnowledge.drugCharacteristic', 'type'=>'MedicationKnowledge::DrugCharacteristic', 'min'=>0, 'max'=>Float::INFINITY},
        'contraindication' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DetectedIssue'], 'path'=>'MedicationKnowledge.contraindication', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'regulatory' => {'path'=>'MedicationKnowledge.regulatory', 'type'=>'MedicationKnowledge::Regulatory', 'min'=>0, 'max'=>Float::INFINITY},
        'kinetics' => {'path'=>'MedicationKnowledge.kinetics', 'type'=>'MedicationKnowledge::Kinetics', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Monograph < Model
        ...
        METADATA = {
          ...
          'source' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DocumentReference', 'http://hl7.org/fhir/StructureDefinition/Media'], 'path'=>'Monograph.source', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }
      ...
      class Ingredient < Model
        ...
        METADATA = {
          ...
          'itemCodeableConcept' => {'path'=>'Ingredient.item[x]', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'itemReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Substance'], 'path'=>'Ingredient.item[x]', 'type'=>'Reference', 'min'=>1, 'max'=>1},
          'isActive' => {'path'=>'Ingredient.isActive', 'type'=>'boolean', 'min'=>0, 'max'=>1},
          'strength' => {'path'=>'Ingredient.strength', 'type'=>'Ratio', 'min'=>0, 'max'=>1}
        }
      ...
      class Cost < Model
        ...
        METADATA = {
          ...
          'cost' => {'path'=>'Cost.cost', 'type'=>'Money', 'min'=>1, 'max'=>1}
        }
      ...
      class AdministrationGuidelines < Model
        ...
        METADATA = {
          'id' => {'path'=>'AdministrationGuidelines.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'AdministrationGuidelines.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'AdministrationGuidelines.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'dosage' => {'path'=>'AdministrationGuidelines.dosage', 'type'=>'MedicationKnowledge::AdministrationGuidelines::Dosage', 'min'=>0, 'max'=>Float::INFINITY},
          'indicationCodeableConcept' => {'path'=>'AdministrationGuidelines.indication[x]', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'indicationReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/ObservationDefinition'], 'path'=>'AdministrationGuidelines.indication[x]', 'type'=>'Reference', 'min'=>0, 'max'=>1},
          'patientCharacteristics' => {'path'=>'AdministrationGuidelines.patientCharacteristics', 'type'=>'MedicationKnowledge::AdministrationGuidelines::PatientCharacteristics', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class PatientCharacteristics < Model
          ...
          METADATA = {
            'id' => {'path'=>'PatientCharacteristics.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'PatientCharacteristics.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'PatientCharacteristics.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'characteristicCodeableConcept' => {'path'=>'PatientCharacteristics.characteristic[x]', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
            'characteristicQuantity' => {'path'=>'PatientCharacteristics.characteristic[x]', 'type'=>'Quantity', 'min'=>1, 'max'=>1},
            'value' => {'path'=>'PatientCharacteristics.value', 'type'=>'string', 'min'=>0, 'max'=>Float::INFINITY}
          }
      ...
      class Packaging < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/medicationknowledge-package-type'=>['amp', 'bag', 'blstrpk', 'bot', 'box', 'can', 'cart', 'disk', 'doset', 'jar', 'jug', 'minim', 'nebamp', 'ovul', 'pch', 'pkt', 'sash', 'strip', 'tin', 'tub', 'tube', 'vial']}, 'path'=>'Packaging.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medicationknowledge-package-type'}},
          'quantity' => {'path'=>'Packaging.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1}
        }
      ...
      class DrugCharacteristic < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/medicationknowledge-characteristic'=>['imprintcd', 'size', 'shape', 'color', 'coating', 'scoring', 'logo']}, 'path'=>'DrugCharacteristic.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medicationknowledge-characteristic'}},
      ...
      class Regulatory < Model
        ...
        METADATA = {
          ...
          'schedule' => {'path'=>'Regulatory.schedule', 'type'=>'MedicationKnowledge::Regulatory::Schedule', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Schedule < Model
          ...
          METADATA = {
            'id' => {'path'=>'Schedule.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'Schedule.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'Schedule.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'schedule' => {'path'=>'Schedule.schedule', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1}
          }
      ...
      class Kinetics < Model
        ...
        METADATA = {
          'id' => {'path'=>'Kinetics.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Kinetics.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Kinetics.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'areaUnderCurve' => {'path'=>'Kinetics.areaUnderCurve', 'type'=>'Quantity', 'min'=>0, 'max'=>Float::INFINITY},
          'lethalDose50' => {'path'=>'Kinetics.lethalDose50', 'type'=>'Quantity', 'min'=>0, 'max'=>Float::INFINITY},
          'halfLifePeriod' => {'path'=>'Kinetics.halfLifePeriod', 'type'=>'Duration', 'min'=>0, 'max'=>1}
        }

module FHIR
  module R4B
    class DetectedIssue < Model
      ...
      METADATA = {
        'id' => {'path'=>'DetectedIssue.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'DetectedIssue.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'DetectedIssue.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'DetectedIssue.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        'text' => {'path'=>'DetectedIssue.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'DetectedIssue.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'DetectedIssue.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'DetectedIssue.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'identifier' => {'path'=>'DetectedIssue.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/observation-status'=>['registered', 'preliminary', 'final', 'amended', 'corrected', 'cancelled', 'entered-in-error', 'unknown']}, 'path'=>'DetectedIssue.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-status'}},
        'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>['_AdministrationDetectedIssueCode', '_AppropriatenessDetectedIssueCode', '_InteractionDetectedIssueCode', 'FOOD', 'TPROD', 'DRG', 'NHP', 'NONRX', 'OBSA', 'AGE', 'ADALRT', 'DOSEHINDA', 'DOSELINDA', 'GEALRT', 'PEALRT', 'COND', 'HGHT', 'LACT', 'PREG', 'WGHT', 'CREACT', 'GEN', 'GEND', 'LAB', 'REACT', 'ALGY', 'INT', 'RREACT', 'RALG', 'RAR', 'RINT', 'PREVINEF', 'COMPLY', 'DUPTHPY', 'DUPTHPCLS', 'DUPTHPGEN', 'ABUSE', 'FRAUD', 'PLYDOC', 'PLYPHRM', 'DACT', 'DOSE', 'DOSECOND', 'DOSEDUR', 'DOSEDURH', 'DOSEDURHIND', 'DOSEDURL', 'DOSEDURLIND', 'DOSEH', 'DOSEHIND', 'DOSEHINDSA', 'DOSEHINDW', 'DOSEIVL', 'DOSEIVLIND', 'DOSEL', 'DOSELIND', 'DOSELINDSA', 'DOSELINDW', 'MDOSE', 'TIME', 'ALRTENDLATE', 'ALRTSTRTLATE', '_DrugActionDetectedIssueCode', '_TimingDetectedIssueCode', 'ENDLATE', 'STRTLATE', '_ActSuppliedItemDetectedIssueCode', '_SupplyDetectedIssueCode', 'ALLDONE', 'FULFIL', 'NOTACTN', 'NOTEQUIV', 'NOTEQUIVGEN', 'NOTEQUIVTHER', 'TIMING', 'INTERVAL', 'MINFREQ', 'HELD', 'TOOLATE', 'TOOSOON', 'HISTORIC', 'PATPREF', 'PATPREFALT']}, 'path'=>'DetectedIssue.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-category'}},
        'severity' => {'valid_codes'=>{'http://hl7.org/fhir/detectedissue-severity'=>['high', 'moderate', 'low']}, 'path'=>'DetectedIssue.severity', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-severity'}},
        'patient' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient'], 'path'=>'DetectedIssue.patient', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'identifiedDateTime' => {'path'=>'DetectedIssue.identified[x]', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'identifiedPeriod' => {'path'=>'DetectedIssue.identified[x]', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'author' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Device'], 'path'=>'DetectedIssue.author', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'implicated' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'path'=>'DetectedIssue.implicated', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'evidence' => {'path'=>'DetectedIssue.evidence', 'type'=>'DetectedIssue::Evidence', 'min'=>0, 'max'=>Float::INFINITY},
        'detail' => {'path'=>'DetectedIssue.detail', 'type'=>'string', 'min'=>0, 'max'=>1},
        'reference' => {'path'=>'DetectedIssue.reference', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'mitigation' => {'path'=>'DetectedIssue.mitigation', 'type'=>'DetectedIssue::Mitigation', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Evidence < Model
        ...
        METADATA = {
          'id' => {'path'=>'Evidence.id', 'type'=>'string', 'min'=>0, 'max'=>1},
      ...
      class Mitigation < Model
        ...
        METADATA = {
          'id' => {'path'=>'Mitigation.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Mitigation.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Mitigation.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'action' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>['_ActDetectedIssueManagementCode', '_ActAdministrativeDetectedIssueManagementCode', '_AuthorizationIssueManagementCode', 'EMAUTH', '21', '1', '19', '2', '22', '23', '3', '4', '5', '6', '7', '14', '15', '16', '17', '18', '20', '8', '10', '11', '12', '13', '9', '_ActFinancialDetectedIssueManagementCode']}, 'path'=>'Mitigation.action', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action'}},
          'date' => {'path'=>'Mitigation.date', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
          'author' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole'], 'path'=>'Mitigation.author', 'type'=>'Reference', 'min'=>0, 'max'=>1}
        }

  ...
  module R4B
    class BiologicallyDerivedProduct < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'BiologicallyDerivedProduct.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        ...
        'productCategory' => {'valid_codes'=>{'http://hl7.org/fhir/product-category'=>['organ', 'tissue', 'fluid', 'cells', 'biologicalAgent']}, 'path'=>'BiologicallyDerivedProduct.productCategory', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-category'}},
        'productCode' => {'path'=>'BiologicallyDerivedProduct.productCode', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example'}},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/product-status'=>['available', 'unavailable']}, 'path'=>'BiologicallyDerivedProduct.status', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-status'}},
        ...
        'quantity' => {'path'=>'BiologicallyDerivedProduct.quantity', 'type'=>'integer', 'min'=>0, 'max'=>1},
        ...
        'processing' => {'path'=>'BiologicallyDerivedProduct.processing', 'type'=>'BiologicallyDerivedProduct::Processing', 'min'=>0, 'max'=>Float::INFINITY},
        'manipulation' => {'path'=>'BiologicallyDerivedProduct.manipulation', 'type'=>'BiologicallyDerivedProduct::Manipulation', 'min'=>0, 'max'=>1},
        'storage' => {'path'=>'BiologicallyDerivedProduct.storage', 'type'=>'BiologicallyDerivedProduct::Storage', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Manipulation < Model
        ...
        METADATA = {
          'id' => {'path'=>'Manipulation.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Manipulation.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Manipulation.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'Manipulation.description', 'type'=>'string', 'min'=>0, 'max'=>1},
          'timeDateTime' => {'path'=>'Manipulation.time[x]', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
          'timePeriod' => {'path'=>'Manipulation.time[x]', 'type'=>'Period', 'min'=>0, 'max'=>1}
        }
      ...
      class Storage < Model
        ...
        METADATA = {
          'id' => {'path'=>'Storage.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Storage.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Storage.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'Storage.description', 'type'=>'string', 'min'=>0, 'max'=>1},
          'temperature' => {'path'=>'Storage.temperature', 'type'=>'decimal', 'min'=>0, 'max'=>1},
          'scale' => {'valid_codes'=>{'http://hl7.org/fhir/product-storage-scale'=>['farenheit', 'celsius', 'kelvin']}, 'path'=>'Storage.scale', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/product-storage-scale'}},
          'duration' => {'path'=>'Storage.duration', 'type'=>'Period', 'min'=>0, 'max'=>1}
        }

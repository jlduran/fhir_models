  ...
  module R4B
    class DeviceDefinition < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'DeviceDefinition.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        ...
        'manufacturerString' => {'path'=>'DeviceDefinition.manufacturer[x]', 'type'=>'string', 'min'=>0, 'max'=>1},
        'manufacturerReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'DeviceDefinition.manufacturer[x]', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'url' => {'path'=>'DeviceDefinition.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'onlineInformation' => {'path'=>'DeviceDefinition.onlineInformation', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'note' => {'path'=>'DeviceDefinition.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
        'quantity' => {'path'=>'DeviceDefinition.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
        'parentDevice' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DeviceDefinition'], 'path'=>'DeviceDefinition.parentDevice', 'type'=>'Reference', 'min'=>0, 'max'=>1},
      ...
      class Specialization < Model
        ...
        METADATA = {
          ...
          'systemType' => {'path'=>'Specialization.systemType', 'type'=>'string', 'min'=>1, 'max'=>1},
      ...
      class Capability < Model
        ...
        METADATA = {
          ...
          'type' => {'path'=>'Capability.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'description' => {'path'=>'Capability.description', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY}
        }

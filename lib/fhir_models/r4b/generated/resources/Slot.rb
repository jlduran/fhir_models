  ...
  module R4B
    class Slot < Model
      ...
      METADATA = {
        ...
        'appointmentType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0276'=>['ROUTINE', 'WALKIN', 'CHECKUP', 'FOLLOWUP', 'EMERGENCY']}, 'path'=>'Slot.appointmentType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://terminology.hl7.org/ValueSet/v2-0276'}},

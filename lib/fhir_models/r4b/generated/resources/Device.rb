  ...
  module R4B
    class Device < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'Device.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        ...
        'definition' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DeviceDefinition'], 'path'=>'Device.definition', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'udiCarrier' => {'path'=>'Device.udiCarrier', 'type'=>'Device::UdiCarrier', 'min'=>0, 'max'=>Float::INFINITY},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/device-status'=>['active', 'inactive', 'entered-in-error', 'unknown']}, 'path'=>'Device.status', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/device-status'}},
        'statusReason' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/device-status-reason'=>['online', 'paused', 'standby', 'offline', 'not-ready', 'transduc-discon', 'hw-discon', 'off']}, 'path'=>'Device.statusReason', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/device-status-reason'}},
        'distinctIdentifier' => {'path'=>'Device.distinctIdentifier', 'type'=>'string', 'min'=>0, 'max'=>1},
        ...
        'patient' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient'], 'path'=>'Device.patient', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'safety' => {'path'=>'Device.safety', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class UdiCarrier < Model
        ...
        METADATA = {
          ...
          'deviceIdentifier' => {'path'=>'UdiCarrier.deviceIdentifier', 'type'=>'string', 'min'=>0, 'max'=>1},
          'issuer' => {'path'=>'UdiCarrier.issuer', 'type'=>'uri', 'min'=>0, 'max'=>1},
          ...
          'entryType' => {'valid_codes'=>{'http://hl7.org/fhir/udi-entry-type'=>['barcode', 'rfid', 'manual', 'card', 'self-reported', 'unknown']}, 'path'=>'UdiCarrier.entryType', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/udi-entry-type'}}
        }
      ...
      class DeviceName < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/device-nametype'=>['udi-label-name', 'user-friendly-name', 'patient-reported-name', 'manufacturer-name', 'model-name', 'other']}, 'path'=>'DeviceName.type', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/device-nametype'}}
        }
      ...
      class Specialization < Model
        ...
        METADATA = {
          'id' => {'path'=>'Specialization.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Specialization.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Specialization.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'systemType' => {'path'=>'Specialization.systemType', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'version' => {'path'=>'Specialization.version', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class Property < Model
        ...
        METADATA = {
          ...
          'type' => {'path'=>'Property.type', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
          'valueQuantity' => {'path'=>'Property.valueQuantity', 'type'=>'Quantity', 'min'=>0, 'max'=>Float::INFINITY},
          'valueCode' => {'path'=>'Property.valueCode', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY}
        }

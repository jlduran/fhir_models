    ...
    class Measure < Model
      ...
      class Group < Model
        ...
        class Stratifier < Model
          ...
          METADATA = {
            ...
            'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-stratifier-example'=>['age', 'gender', 'region']}, 'path'=>'Stratifier.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-stratifier-example'}},
          ...
          class Component < Model
            ...
            METADATA = {
              ...
              'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-stratifier-example'=>['age', 'gender', 'region']}, 'path'=>'Component.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-stratifier-example'}},
      ...
      class SupplementalData < Model
        ...
        METADATA = {
          ...
          'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-supplemental-data-example'=>['age', 'gender', 'ethnicity', 'payer']}, 'path'=>'SupplementalData.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-supplemental-data-example'}},

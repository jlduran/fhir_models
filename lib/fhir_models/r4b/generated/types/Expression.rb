  ...
  module R4B
    class Expression < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'http://hl7.org/fhir/expression-language'=>['text/cql', 'text/fhirpath', 'application/x-fhir-query', 'text/cql-identifier', 'text/cql-expression']}, 'path'=>'Expression.language', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/expression-language'}},

  ...
  module R4
    class NutritionOrder < Model
      ...
      class OralDiet < Model
        ...
        METADATA = {
          'id' => {'path'=>'OralDiet.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'OralDiet.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'OralDiet.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'valid_codes'=>{'http://snomed.info/sct'=>['38903004', '50712000', '56948003', '61420007', '182954008', '182955009', '182956005', '182957001', '182958006', '182959003', '182960008', '183028005', '223456000', '225373002', '225374008', '229912004', '229913009', '229914003', '229915002', '229916001', '229917005', '284071006', '289133003', '310244003', '361231003', '386261001', '404919001', '422972009', '425458000', '1151000175103']}, 'path'=>'OralDiet.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/diet-type'}},
          'schedule' => {'path'=>'OralDiet.schedule', 'type'=>'Timing', 'min'=>0, 'max'=>Float::INFINITY},
          'nutrient' => {'path'=>'OralDiet.nutrient', 'type'=>'NutritionOrder::OralDiet::Nutrient', 'min'=>0, 'max'=>Float::INFINITY},
          'texture' => {'path'=>'OralDiet.texture', 'type'=>'NutritionOrder::OralDiet::Texture', 'min'=>0, 'max'=>Float::INFINITY},
          'fluidConsistencyType' => {'valid_codes'=>{'http://snomed.info/sct'=>['439031000124108', '439021000124105', '439041000124103', '439081000124109']}, 'path'=>'OralDiet.fluidConsistencyType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/consistency-type'}},
          'instruction' => {'path'=>'OralDiet.instruction', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
        ...
        class Texture < Model
          ...
          METADATA = {
            'id' => {'path'=>'Texture.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'Texture.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'Texture.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifier' => {'valid_codes'=>{'http://snomed.info/sct'=>['228053002', '439091000124107', '228049004', '441881000124103', '441761000124103', '441751000124100', '228059003', '441791000124106', '228055009', '228056005', '441771000124105', '228057001', '228058006', '228060008']}, 'path'=>'Texture.modifier', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/texture-code'}},
            'foodType' => {'valid_codes'=>{'http://snomed.info/sct'=>['255620007', '28647000', '22836000', '72511004', '226760005', '226887002', '102263004', '74242007', '227415002', '264331002', '227518002', '44027008', '226529007', '227210005']}, 'path'=>'Texture.foodType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/modified-foodtype'}}
          }
      ...
      class Supplement < Model
        ...
        METADATA = {
          'id' => {'path'=>'Supplement.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Supplement.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Supplement.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'type' => {'valid_codes'=>{'http://snomed.info/sct'=>['442901000124106', '443031000124106', '443051000124104', '442911000124109', '443021000124108', '442971000124100', '442981000124102', '442991000124104', '443011000124100', '442961000124107', '442951000124105', '442941000124108', '442921000124101', '442931000124103', '444331000124106', '443361000124100', '443391000124108', '443401000124105', '443491000124103', '443501000124106', '443421000124100', '443471000124104', '444431000124104', '443451000124109', '444321000124108', '441561000124106', '443461000124106', '441531000124102', '443561000124107', '443481000124101', '441571000124104', '441591000124103', '441601000124106', '443351000124102', '443771000124106', '441671000124100', '443111000124101', '443431000124102', '443411000124108', '444361000124102', '444401000124107', '444381000124107', '444371000124109', '443441000124107', '442651000124102']}, 'path'=>'Supplement.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/supplement-type'}},
          'productName' => {'path'=>'Supplement.productName', 'type'=>'string', 'min'=>0, 'max'=>1},
          'schedule' => {'path'=>'Supplement.schedule', 'type'=>'Timing', 'min'=>0, 'max'=>Float::INFINITY},
          'quantity' => {'path'=>'Supplement.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
          'instruction' => {'path'=>'Supplement.instruction', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class EnteralFormula < Model
        ...
        METADATA = {
          'id' => {'path'=>'EnteralFormula.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'EnteralFormula.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'EnteralFormula.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'baseFormulaType' => {'valid_codes'=>{'http://snomed.info/sct'=>['443031000124106', '443051000124104', '442911000124109', '443021000124108', '442971000124100', '442981000124102', '442991000124104', '443011000124100', '442961000124107', '442951000124105', '442941000124108', '442921000124101', '442931000124103', '443361000124100', '443401000124105', '443491000124103', '443501000124106', '443421000124100', '443471000124104', '444431000124104', '443451000124109', '441561000124106', '443461000124106', '441531000124102', '443561000124107', '443481000124101', '441571000124104', '441591000124103', '441601000124106', '443351000124102', '443771000124106', '441671000124100', '443111000124101', '443431000124102', '443411000124108', '442651000124102']}, 'path'=>'EnteralFormula.baseFormulaType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/entformula-type'}},
          'baseFormulaProductName' => {'path'=>'EnteralFormula.baseFormulaProductName', 'type'=>'string', 'min'=>0, 'max'=>1},
          'additiveType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/entformula-additive'=>['lipid', 'protein', 'carbohydrate', 'fiber', 'water']}, 'path'=>'EnteralFormula.additiveType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/entformula-additive'}},
          'additiveProductName' => {'path'=>'EnteralFormula.additiveProductName', 'type'=>'string', 'min'=>0, 'max'=>1},
          'caloricDensity' => {'path'=>'EnteralFormula.caloricDensity', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
          'routeofAdministration' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration'=>['PO', 'EFT', 'ENTINSTL', 'GT', 'NGT', 'OGT', 'GJT', 'JJTINSTL', 'OJJ']}, 'path'=>'EnteralFormula.routeofAdministration', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/enteral-route'}},
          'administration' => {'path'=>'EnteralFormula.administration', 'type'=>'NutritionOrder::EnteralFormula::Administration', 'min'=>0, 'max'=>Float::INFINITY},
          'maxVolumeToDeliver' => {'path'=>'EnteralFormula.maxVolumeToDeliver', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
          'administrationInstruction' => {'path'=>'EnteralFormula.administrationInstruction', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
        ...
        class Administration < Model
          ...
          METADATA = {
            'id' => {'path'=>'Administration.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'Administration.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'Administration.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'schedule' => {'path'=>'Administration.schedule', 'type'=>'Timing', 'min'=>0, 'max'=>1},
            'quantity' => {'path'=>'Administration.quantity', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
            'rateQuantity' => {'path'=>'Administration.rate[x]', 'type'=>'Quantity', 'min'=>0, 'max'=>1},
            'rateRatio' => {'path'=>'Administration.rate[x]', 'type'=>'Ratio', 'min'=>0, 'max'=>1}
          }

  ...
  module R4
    class VerificationResult < Model
      ...
      METADATA = {
        ...
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/CodeSystem/status'=>['attested', 'validated', 'in-process', 'req-revalid', 'val-fail', 'reval-fail']}, 'path'=>'VerificationResult.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/verificationresult-status'}},

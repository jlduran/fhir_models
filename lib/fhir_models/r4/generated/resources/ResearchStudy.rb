  ...
  module R4
    class ResearchStudy < Model
      ...
      METADATA = {
        ...
        'location' => {'path'=>'ResearchStudy.location', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/jurisdiction'}},
        'description' => {'path'=>'ResearchStudy.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'enrollment' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Group'], 'path'=>'ResearchStudy.enrollment', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'period' => {'path'=>'ResearchStudy.period', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'sponsor' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'path'=>'ResearchStudy.sponsor', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'principalInvestigator' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole'], 'path'=>'ResearchStudy.principalInvestigator', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'site' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Location'], 'path'=>'ResearchStudy.site', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY},
        'reasonStopped' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/research-study-reason-stopped'=>['accrual-goal-met', 'closed-due-to-toxicity', 'closed-due-to-lack-of-study-progress', 'temporarily-closed-per-study-design']}, 'path'=>'ResearchStudy.reasonStopped', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-reason-stopped'}},
        'note' => {'path'=>'ResearchStudy.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
        'arm' => {'path'=>'ResearchStudy.arm', 'type'=>'ResearchStudy::Arm', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Arm < Model
        ...
        METADATA = {
          'id' => {'path'=>'Arm.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Arm.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Arm.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'name' => {'path'=>'Arm.name', 'type'=>'string', 'min'=>1, 'max'=>1},
          'type' => {'path'=>'Arm.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'description' => {'path'=>'Arm.description', 'type'=>'string', 'min'=>0, 'max'=>1}
        }
      ...
      class Objective < Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/research-study-objective-type'=>['primary', 'secondary', 'exploratory']}, 'path'=>'Objective.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/research-study-objective-type'}}
        }

module FHIR
  module R4
    class RiskEvidenceSynthesis < Model
      ...
      METADATA = {
        'id' => {'path'=>'RiskEvidenceSynthesis.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'RiskEvidenceSynthesis.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'RiskEvidenceSynthesis.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'RiskEvidenceSynthesis.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        'text' => {'path'=>'RiskEvidenceSynthesis.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'RiskEvidenceSynthesis.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'RiskEvidenceSynthesis.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'RiskEvidenceSynthesis.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'url' => {'path'=>'RiskEvidenceSynthesis.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'identifier' => {'path'=>'RiskEvidenceSynthesis.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'path'=>'RiskEvidenceSynthesis.version', 'type'=>'string', 'min'=>0, 'max'=>1},
        'name' => {'path'=>'RiskEvidenceSynthesis.name', 'type'=>'string', 'min'=>0, 'max'=>1},
        'title' => {'path'=>'RiskEvidenceSynthesis.title', 'type'=>'string', 'min'=>0, 'max'=>1},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'path'=>'RiskEvidenceSynthesis.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        'date' => {'path'=>'RiskEvidenceSynthesis.date', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'publisher' => {'path'=>'RiskEvidenceSynthesis.publisher', 'type'=>'string', 'min'=>0, 'max'=>1},
        'contact' => {'path'=>'RiskEvidenceSynthesis.contact', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'description' => {'path'=>'RiskEvidenceSynthesis.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'note' => {'path'=>'RiskEvidenceSynthesis.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
        'useContext' => {'path'=>'RiskEvidenceSynthesis.useContext', 'type'=>'UsageContext', 'min'=>0, 'max'=>Float::INFINITY},
        'jurisdiction' => {'path'=>'RiskEvidenceSynthesis.jurisdiction', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/jurisdiction'}},
        'copyright' => {'path'=>'RiskEvidenceSynthesis.copyright', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'approvalDate' => {'path'=>'RiskEvidenceSynthesis.approvalDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'lastReviewDate' => {'path'=>'RiskEvidenceSynthesis.lastReviewDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'effectivePeriod' => {'path'=>'RiskEvidenceSynthesis.effectivePeriod', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'topic' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/definition-topic'=>['treatment', 'education', 'assessment']}, 'path'=>'RiskEvidenceSynthesis.topic', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/definition-topic'}},
        'author' => {'path'=>'RiskEvidenceSynthesis.author', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'editor' => {'path'=>'RiskEvidenceSynthesis.editor', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'reviewer' => {'path'=>'RiskEvidenceSynthesis.reviewer', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'endorser' => {'path'=>'RiskEvidenceSynthesis.endorser', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'relatedArtifact' => {'path'=>'RiskEvidenceSynthesis.relatedArtifact', 'type'=>'RelatedArtifact', 'min'=>0, 'max'=>Float::INFINITY},
        'synthesisType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/synthesis-type'=>['std-MA', 'IPD-MA', 'indirect-NMA', 'combined-NMA', 'range', 'classification']}, 'path'=>'RiskEvidenceSynthesis.synthesisType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/synthesis-type'}},
        'studyType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/study-type'=>['RCT', 'CCT', 'cohort', 'case-control', 'series', 'case-report', 'mixed']}, 'path'=>'RiskEvidenceSynthesis.studyType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/study-type'}},
        'population' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'RiskEvidenceSynthesis.population', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'exposure' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'RiskEvidenceSynthesis.exposure', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        'outcome' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'RiskEvidenceSynthesis.outcome', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'sampleSize' => {'path'=>'RiskEvidenceSynthesis.sampleSize', 'type'=>'RiskEvidenceSynthesis::SampleSize', 'min'=>0, 'max'=>1},
        'riskEstimate' => {'path'=>'RiskEvidenceSynthesis.riskEstimate', 'type'=>'RiskEvidenceSynthesis::RiskEstimate', 'min'=>0, 'max'=>1},
        'certainty' => {'path'=>'RiskEvidenceSynthesis.certainty', 'type'=>'RiskEvidenceSynthesis::Certainty', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class Certainty < Model
        ...
        METADATA = {
          ...
          'certaintySubcomponent' => {'path'=>'Certainty.certaintySubcomponent', 'type'=>'RiskEvidenceSynthesis::Certainty::CertaintySubcomponent', 'min'=>0, 'max'=>Float::INFINITY}
        }

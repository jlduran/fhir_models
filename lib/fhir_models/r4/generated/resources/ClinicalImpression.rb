  ...
  module R4
    class ClinicalImpression < Model
      ...
      METADATA = {
        ...
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'ClinicalImpression.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        ...
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/event-status'=>['in-progress', 'completed', 'entered-in-error']}, 'path'=>'ClinicalImpression.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/clinicalimpression-status'}},
        'statusReason' => {'path'=>'ClinicalImpression.statusReason', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example'}},
        'code' => {'path'=>'ClinicalImpression.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example'}},
        ...
        'assessor' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole'], 'path'=>'ClinicalImpression.assessor', 'type'=>'Reference', 'min'=>0, 'max'=>1},
        ...
        'investigation' => {'path'=>'ClinicalImpression.investigation', 'type'=>'ClinicalImpression::Investigation', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'prognosisCodeableConcept' => {'valid_codes'=>{'http://snomed.info/sct'=>['60484009', '65872000', '67334001', '170968001', '170969009', '170970005']}, 'path'=>'ClinicalImpression.prognosisCodeableConcept', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/clinicalimpression-prognosis'}},
      ...
      class Investigation < Model
        ...
        METADATA = {
          'id' => {'path'=>'Investigation.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'Investigation.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'Investigation.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'code' => {'valid_codes'=>{'http://snomed.info/sct'=>['271336007', '160237006']}, 'path'=>'Investigation.code', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/investigation-sets'}},
          'item' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Observation', 'http://hl7.org/fhir/StructureDefinition/QuestionnaireResponse', 'http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory', 'http://hl7.org/fhir/StructureDefinition/DiagnosticReport', 'http://hl7.org/fhir/StructureDefinition/RiskAssessment', 'http://hl7.org/fhir/StructureDefinition/ImagingStudy', 'http://hl7.org/fhir/StructureDefinition/Media'], 'path'=>'Investigation.item', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY}
        }

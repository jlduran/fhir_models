      ...
      class Group < Model
        ...
        class Stratifier < Model
          ...
          METADATA = {
            ...
            'code' => {'path'=>'Stratifier.code', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          class Stratum < Model
            ...
            METADATA = {
              ...
              'value' => {'path'=>'Stratum.value', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
            ...
            class Component < Model
              ...
              METADATA = {
                ...
                'code' => {'path'=>'Component.code', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1},
                'value' => {'path'=>'Component.value', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1}
              }

    ...
    class DetectedIssue < Model
      ...
      class Mitigation < Model
        ...
        METADATA = {
          ...
          'action' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>['EMAUTH', '21', '1', '19', '2', '22', '23', '3', '4', '5', '6', '7', '14', '15', '16', '17', '18', '20', '8', '10', '11', '12', '13', '9']}, 'path'=>'Mitigation.action', 'type'=>'CodeableConcept', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action'}},

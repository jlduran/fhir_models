  ...
  module R4
    class SubstanceReferenceInformation < Model
      ...
      METADATA = {
        ...
        'classification' => {'path'=>'SubstanceReferenceInformation.classification', 'type'=>'SubstanceReferenceInformation::Classification', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Classification < Model
        ...
        METADATA = {
          ...
          'domain' => {'path'=>'Classification.domain', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'classification' => {'path'=>'Classification.classification', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1},
          'subtype' => {'path'=>'Classification.subtype', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY},
          'source' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DocumentReference'], 'path'=>'Classification.source', 'type'=>'Reference', 'min'=>0, 'max'=>Float::INFINITY}
        }

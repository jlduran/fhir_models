module FHIR
  module R4
    class EffectEvidenceSynthesis < Model
      ...
      METADATA = {
        'id' => {'path'=>'EffectEvidenceSynthesis.id', 'type'=>'id', 'min'=>0, 'max'=>1},
        'meta' => {'path'=>'EffectEvidenceSynthesis.meta', 'type'=>'Meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'path'=>'EffectEvidenceSynthesis.implicitRules', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'path'=>'EffectEvidenceSynthesis.language', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        'text' => {'path'=>'EffectEvidenceSynthesis.text', 'type'=>'Narrative', 'min'=>0, 'max'=>1},
        'contained' => {'path'=>'EffectEvidenceSynthesis.contained', 'type'=>'Resource', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'path'=>'EffectEvidenceSynthesis.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'path'=>'EffectEvidenceSynthesis.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
        'url' => {'path'=>'EffectEvidenceSynthesis.url', 'type'=>'uri', 'min'=>0, 'max'=>1},
        'identifier' => {'path'=>'EffectEvidenceSynthesis.identifier', 'type'=>'Identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'path'=>'EffectEvidenceSynthesis.version', 'type'=>'string', 'min'=>0, 'max'=>1},
        'name' => {'path'=>'EffectEvidenceSynthesis.name', 'type'=>'string', 'min'=>0, 'max'=>1},
        'title' => {'path'=>'EffectEvidenceSynthesis.title', 'type'=>'string', 'min'=>0, 'max'=>1},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'path'=>'EffectEvidenceSynthesis.status', 'type'=>'code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        'date' => {'path'=>'EffectEvidenceSynthesis.date', 'type'=>'dateTime', 'min'=>0, 'max'=>1},
        'publisher' => {'path'=>'EffectEvidenceSynthesis.publisher', 'type'=>'string', 'min'=>0, 'max'=>1},
        'contact' => {'path'=>'EffectEvidenceSynthesis.contact', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'description' => {'path'=>'EffectEvidenceSynthesis.description', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'note' => {'path'=>'EffectEvidenceSynthesis.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
        'useContext' => {'path'=>'EffectEvidenceSynthesis.useContext', 'type'=>'UsageContext', 'min'=>0, 'max'=>Float::INFINITY},
        'jurisdiction' => {'path'=>'EffectEvidenceSynthesis.jurisdiction', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/jurisdiction'}},
        'copyright' => {'path'=>'EffectEvidenceSynthesis.copyright', 'type'=>'markdown', 'min'=>0, 'max'=>1},
        'approvalDate' => {'path'=>'EffectEvidenceSynthesis.approvalDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'lastReviewDate' => {'path'=>'EffectEvidenceSynthesis.lastReviewDate', 'type'=>'date', 'min'=>0, 'max'=>1},
        'effectivePeriod' => {'path'=>'EffectEvidenceSynthesis.effectivePeriod', 'type'=>'Period', 'min'=>0, 'max'=>1},
        'topic' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/definition-topic'=>['treatment', 'education', 'assessment']}, 'path'=>'EffectEvidenceSynthesis.topic', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/definition-topic'}},
        'author' => {'path'=>'EffectEvidenceSynthesis.author', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'editor' => {'path'=>'EffectEvidenceSynthesis.editor', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'reviewer' => {'path'=>'EffectEvidenceSynthesis.reviewer', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'endorser' => {'path'=>'EffectEvidenceSynthesis.endorser', 'type'=>'ContactDetail', 'min'=>0, 'max'=>Float::INFINITY},
        'relatedArtifact' => {'path'=>'EffectEvidenceSynthesis.relatedArtifact', 'type'=>'RelatedArtifact', 'min'=>0, 'max'=>Float::INFINITY},
        'synthesisType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/synthesis-type'=>['std-MA', 'IPD-MA', 'indirect-NMA', 'combined-NMA', 'range', 'classification']}, 'path'=>'EffectEvidenceSynthesis.synthesisType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/synthesis-type'}},
        'studyType' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/study-type'=>['RCT', 'CCT', 'cohort', 'case-control', 'series', 'case-report', 'mixed']}, 'path'=>'EffectEvidenceSynthesis.studyType', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/study-type'}},
        'population' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'EffectEvidenceSynthesis.population', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'exposure' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'EffectEvidenceSynthesis.exposure', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'exposureAlternative' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'EffectEvidenceSynthesis.exposureAlternative', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'outcome' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/EvidenceVariable'], 'path'=>'EffectEvidenceSynthesis.outcome', 'type'=>'Reference', 'min'=>1, 'max'=>1},
        'sampleSize' => {'path'=>'EffectEvidenceSynthesis.sampleSize', 'type'=>'EffectEvidenceSynthesis::SampleSize', 'min'=>0, 'max'=>1},
        'resultsByExposure' => {'path'=>'EffectEvidenceSynthesis.resultsByExposure', 'type'=>'EffectEvidenceSynthesis::ResultsByExposure', 'min'=>0, 'max'=>Float::INFINITY},
        'effectEstimate' => {'path'=>'EffectEvidenceSynthesis.effectEstimate', 'type'=>'EffectEvidenceSynthesis::EffectEstimate', 'min'=>0, 'max'=>Float::INFINITY},
        'certainty' => {'path'=>'EffectEvidenceSynthesis.certainty', 'type'=>'EffectEvidenceSynthesis::Certainty', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      class SampleSize < Model
        ...
        METADATA = {
          ...
          'numberOfStudies' => {'path'=>'SampleSize.numberOfStudies', 'type'=>'integer', 'min'=>0, 'max'=>1},
          'numberOfParticipants' => {'path'=>'SampleSize.numberOfParticipants', 'type'=>'integer', 'min'=>0, 'max'=>1}
        }
      ...
      class ResultsByExposure < Model
        ...
        METADATA = {
          'id' => {'path'=>'ResultsByExposure.id', 'type'=>'string', 'min'=>0, 'max'=>1},
          'extension' => {'path'=>'ResultsByExposure.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'path'=>'ResultsByExposure.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
          'description' => {'path'=>'ResultsByExposure.description', 'type'=>'string', 'min'=>0, 'max'=>1},
          'exposureState' => {'valid_codes'=>{'http://hl7.org/fhir/exposure-state'=>['exposure', 'exposure-alternative']}, 'path'=>'ResultsByExposure.exposureState', 'type'=>'code', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/exposure-state'}},
          'variantState' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/evidence-variant-state'=>['low-risk', 'medium-risk', 'high-risk']}, 'path'=>'ResultsByExposure.variantState', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/evidence-variant-state'}},
          'riskEvidenceSynthesis' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/RiskEvidenceSynthesis'], 'path'=>'ResultsByExposure.riskEvidenceSynthesis', 'type'=>'Reference', 'min'=>1, 'max'=>1}
        }
      ...
      class EffectEstimate < Model
        ...
        class PrecisionEstimate < Model
          ...
          METADATA = {
            'id' => {'path'=>'PrecisionEstimate.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'PrecisionEstimate.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'PrecisionEstimate.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/precision-estimate-type'=>['CI', 'IQR', 'SD', 'SE']}, 'path'=>'PrecisionEstimate.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/precision-estimate-type'}},
            'level' => {'path'=>'PrecisionEstimate.level', 'type'=>'decimal', 'min'=>0, 'max'=>1},
            'from' => {'path'=>'PrecisionEstimate.from', 'type'=>'decimal', 'min'=>0, 'max'=>1},
            'to' => {'path'=>'PrecisionEstimate.to', 'type'=>'decimal', 'min'=>0, 'max'=>1}
          }
      ...
      class Certainty < Model
        ...
        METADATA = {
          ...
          'rating' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/evidence-quality'=>['high', 'moderate', 'low', 'very-low']}, 'path'=>'Certainty.rating', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/evidence-quality'}},
          'note' => {'path'=>'Certainty.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY},
          'certaintySubcomponent' => {'path'=>'Certainty.certaintySubcomponent', 'type'=>'EffectEvidenceSynthesis::Certainty::CertaintySubcomponent', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class CertaintySubcomponent < Model
          ...
          METADATA = {
            'id' => {'path'=>'CertaintySubcomponent.id', 'type'=>'string', 'min'=>0, 'max'=>1},
            'extension' => {'path'=>'CertaintySubcomponent.extension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'modifierExtension' => {'path'=>'CertaintySubcomponent.modifierExtension', 'type'=>'Extension', 'min'=>0, 'max'=>Float::INFINITY},
            'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/certainty-subcomponent-type'=>['RiskOfBias', 'Inconsistency', 'Indirectness', 'Imprecision', 'PublicationBias', 'DoseResponseGradient', 'PlausibleConfounding', 'LargeEffect']}, 'path'=>'CertaintySubcomponent.type', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/certainty-subcomponent-type'}},
            'rating' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/certainty-subcomponent-rating'=>['no-change', 'downcode1', 'downcode2', 'downcode3', 'upcode1', 'upcode2', 'no-concern', 'serious-concern', 'critical-concern', 'present', 'absent']}, 'path'=>'CertaintySubcomponent.rating', 'type'=>'CodeableConcept', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/certainty-subcomponent-rating'}},
            'note' => {'path'=>'CertaintySubcomponent.note', 'type'=>'Annotation', 'min'=>0, 'max'=>Float::INFINITY}
          }
